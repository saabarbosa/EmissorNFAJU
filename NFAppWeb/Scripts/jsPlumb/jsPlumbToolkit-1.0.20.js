(function() {
    ...
    var a = {
        ...
        d = function(b, c) {
            ...
            return k = a.subtract(b, c[h]), p = a.square(k), p < m && (m = p, n = 1), {
                location: n,
                distance: m
            }
        },
        ...
        f = function(b, c) {
            for (var d = c.length - 1, e = 2 * d - 1, f = [], g = [], h = [], i = [], k = [
                    ...
                    [.4, .6, .6, .4],
                    [.1, .3, .6, 1]
                ], l = 0; l <= d; l++) f[l] = a.subtract(c[l], b);
            for (var l = 0; l <= d - 1; l++) g[l] = a.subtract(c[l + 1], c[l]), g[l] = a.scale(g[l], 3);
            for (var m = 0; m <= d - 1; m++)
                for (var n = 0; n <= d; n++) h[m] || (h[m] = []), h[m][n] = a.dotProduct(g[m], f[n]);
        ...
        l = function(a, b, c, d, e) {
            ...
            for (var h = 1; h <= b; h++)
                for (var g = 0; g <= b - h; g++) f[h] || (f[h] = []), f[h][g] || (f[h][g] = {}), f[h][g].x = (1 - c) * f[h - 1][g].x + c * f[h - 1][g + 1].x, f[h][g].y = (1 - c) * f[h - 1][g].y + c * f[h - 1][g + 1].y;
            if (null != d)
                for (g = 0; g <= b; g++) d[g] = f[g][0];
            if (null != e)
                for (g = 0; g <= b; g++) e[g] = f[b - g][g];
            return f[b][0]
        },
        m = {},
        n = function(a) {
    ...
    function() {
        ...
        var a = this,
            b = function(a, b, c) {
                return a.indexOf(b) === -1 && (c ? a.unshift(b) : a.push(b), !0)
            },
            c = function(a, b) {
                var c = a.indexOf(b);
                c != -1 && a.splice(c, 1)
            ...
            d = function(a, b) {
                for (var c = [], d = 0; d < a.length; d++) b.indexOf(a[d]) == -1 && c.push(a[d]);
                return c
            },
            e = function(a) {
            ...
            D = function(a, b, c, d) {
                ...
                this.downListener = function(a) {
                    ...
                    if (b && this.isEnabled() && this.canDrag()) {
                        ...
                        if (d) {
                            if (u) {
                                s = this.el.cloneNode(!0), s.setAttribute("id", null), s.style.position = "absolute";
                                var e = f(this.el);
                                s.style.left = e.left + "px", s.style.top = e.top + "px", document.body.appendChild(s)
                            } else s = this.el;
                    ...
                    k && (k = null, this.params.unbind(document, "mousemove", this.moveListener), this.params.unbind(document, "mouseup", this.upListener), this.params.removeClass(document.body, c.noSelect), this.unmark(a), h.unmarkSelection(this, a), h.unmarkPosses(this, a), this.stop(a), h.notifySelectionDragStop(this, a), h.notifyPosseDragStop(this, a), q = !1, u && (s && s.parentNode && s.parentNode.removeChild(s), s = null), M && M(this.el, this.params.getPosition(this.el)) === !0 && (this.params.setPosition(this.el, l), V("revert", this.el)))
                ...
                var V = function(a, b) {
                    if (U[a])
                        for (var c = 0; c < U[a].length; c++) try {
                            U[a][c](b)
                        } catch (a) {}
                };
        ...
        a.Katavorio = function(a) {
            ...
            this.addToPosse = function(a, b) {
                for (var c = [], d = 1; d < arguments.length; d++) c.push(C(a, arguments[d]));
                return 1 == c.length ? c[0] : c
            }, this.setPosse = function(a, b) {
                for (var c = [], e = 1; e < arguments.length; e++) c.push(C(a, arguments[e], !0).name);
                return w(a, function(a) {
                    if (a._katavorioDrag) {
        ...
        }, a.Katavorio.version = "0.19.1", "undefined" != typeof exports && (exports.Katavorio = a.Katavorio)
    }.call("undefined" != typeof window ? window : this),
    function() {
        var a = function(a) {
                return "[object Array]" === Object.prototype.toString.call(a)
        ...
        j.jsPlumbUtil = {
            ...
            extend: function(b, c, d) {
                var e;
                for (c = a(c) ? c : [c], e = 0; e < c.length; e++)
                    for (var f in c[e].prototype) c[e].prototype.hasOwnProperty(f) && (b.prototype[f] = c[e].prototype[f]);
                var g = function(a, b) {
                        return function() {
                    ...
                    h = function(a) {
                        for (var c in a) b.prototype[c] = g(c, a[c])
                    };
                if (arguments.length > 2)
                    for (e = 2; e < arguments.length; e++) h(arguments[e]);
                return b
            },
            uuid: function() {
                return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function(a) {
    ...
    function() {
        ...
        var a, b = this,
            ...
            h = function(a, b, c, d) {
                ...
                if (e)
                    for (var f = 0, g = e.length; f < g; f++) d && d == e[f] || e[f].setHover(b, !0, c)
            },
            i = function(a) {
        ...
        d.extend(b.jsPlumbUIComponent, d.EventGenerator, {
            ...
            addType: function(a, b, c) {
                var d = i(a),
                    e = !1;
                if (null != d) {
                    for (var f = 0, g = d.length; f < g; f++) this.hasType(d[f]) || (this._jsPlumb.types.push(d[f]), e = !0);
                    e && l(this, b, c)
                }
            },
            removeType: function(a, b, c) {
                var d = i(a),
                    ...
                    f = function(a) {
                        ...
                        return b != -1 && (n(this, b), this._jsPlumb.types.splice(b, 1), !0)
                    }.bind(this);
                if (null != d) {
                    for (var g = 0, h = d.length; g < h; g++) e = f(d[g]) || e;
                    e && l(this, b, c)
                }
            },
            clearTypes: function(a, b) {
                for (var c = this._jsPlumb.types.length, d = 0; d < c; d++) n(this, 0), this._jsPlumb.types.splice(0, 1);
                l(this, a, b)
            },
            toggleType: function(a, b, c) {
                ...
                if (null != d) {
                    for (var e = 0, f = d.length; e < f; e++) {
                        ...
                        g != -1 ? (n(this, g), this._jsPlumb.types.splice(g, 1)) : this._jsPlumb.types.push(d[e])
                    }
                    l(this, b, c)
                }
            },
        ...
        var o = 0,
            ...
            q = b.jsPlumbInstance = function(f) {
                this.version = "2.3.0", f && r.extend(this.Defaults, f), this.logEnabled = this.Defaults.LogEnabled, this._connectionTypes = {}, this._endpointTypes = {}, d.EventGenerator.apply(this);
                var h = this,
                    i = p(),
                    j = h.bind,
                    l = {},
                ...
                var u = null,
                            ...
                            if (g && r.isDragSupported(a, h)) {
                                ...
                                if (i = r.extend({}, i), r.isAlreadyDraggable(a, h)) c.force && h.initDraggable(a, i);
                                    ...
                                    var j = r.dragEvents.drag,
                                        ...
                                        m = !1;
                                    qa(e, a), i[l] = d.wrap(i[l], function() {
                                        if (h.setHoverSuspended(!0), h.select({
                                                source: a
                                            }).addClass(h.elementDraggingClass + " " + h.sourceElementDraggingClass, !0), h.select({
                                                target: a
                                            }).addClass(h.elementDraggingClass + " " + h.targetElementDraggingClass, !0), h.setConnectionBeingDragged(!0), i.canDrag) return c.canDrag()
                                    ...
                                    C[n] = !0;
                                    var o = C[n];
                                    i.disabled = null != o && !o, h.initDraggable(a, i), h.getDragManager().register(a), f && h.fire("elementDraggable", {
                                        el: a,
                                        options: i
                                    })
                                }
                    ...
                    P = function(a, b) {
                        var c = r.extend({}, a);
                        if (b && r.extend(c, b), c.source && (c.source.endpoint ? c.sourceEndpoint = c.source : c.source = h.getElement(c.source)), c.target && (c.target.endpoint ? c.targetEndpoint = c.target : c.target = h.getElement(c.target)), a.uuids && (c.sourceEndpoint = M(a.uuids[0]), c.targetEndpoint = M(a.uuids[1])), c.sourceEndpoint && c.sourceEndpoint.isFull()) return void d.log(h, "could not add connection; source endpoint is full");
                        if (c.targetEndpoint && c.targetEndpoint.isFull()) return void d.log(h, "could not add connection; target endpoint is full");
                        if (!c.type && c.sourceEndpoint && (c.type = c.sourceEndpoint.connectionType), c.sourceEndpoint && c.sourceEndpoint.connectorOverlays) {
                            ...
                            for (var e = 0, f = c.sourceEndpoint.connectorOverlays.length; e < f; e++) c.overlays.push(c.sourceEndpoint.connectorOverlays[e])
                        }
                    ...
                    S = function(a, b) {
                        var c = h.Defaults.EndpointType || r.Endpoint,
                            d = r.extend({}, a);
                        d._jsPlumb = h, d.newConnection = Q, d.newEndpoint = S, d.endpointsByUUID = y, d.endpointsByElement = x, d.fireDetachEvent = aa, d.elementId = b || Z(d.source);
                        var e = new c(d);
                        return e.id = "ep_" + J(), qa(d.elementId, d.source), r.headless || h.getDragManager().endpointAdded(d.source, b), e
                    },
                    T = function(a, b, c) {
                        var d = x[a];
                        if (d && d.length)
                    ...
                    W = function(a) {
                        ...
                        return r.each(a, function(a) {
                            ...
                            return b = null != C[c] && C[c], b = !b, C[c] = b, h.setDraggable(a, b), b
                        }.bind(this)), b
                    },
                    X = function(a, b) {
                        var c = null;
                ...
                this.setConnectionBeingDragged = function(a) {
                    ...
                    for (var f = [], g = d.isArray(a) || null != a.length && !d.isString(a) ? a : [a], i = 0, j = g.length; i < j; i++) {
                        e.source = h.getElement(g[i]), oa(e.source);
                        var k = Z(e.source),
                            l = S(e, k),
                            m = qa(k, e.source).info.o;
                    ...
                    if (c && c.length > 0) {
                        ...
                        try {
                            for (var g = 0, i = c.length; g < i; g++) e = e && c[g].apply(c[g], f)
                        } catch (b) {
                    ...
                    var c, e = P(a, b);
                    if (e) {
                        if (null == e.source && null == e.sourceEndpoint) return void d.log("Cannot establish connection - source does not exist");
                        if (null == e.target && null == e.targetEndpoint) return void d.log("Cannot establish connection - target does not exist");
                        oa(e.source), c = Q(e), R(c, e)
                    }
                    return c
                };
                var $ = [{
                    ...
                    _ = function(a, b, c, d) {
                        ...
                        return null != e && (j.detachFromConnection(a), a.endpoints[c] = e, a[h.el] = e.element, a[h.elId] = e.elementId, k[0 === c ? "newSourceId" : "newTargetId"] = e.elementId, ba(k), d || a.repaint()), k.element = b, k
                    }.bind(this);
                this.setSource = function(a, b, c) {
                    ...
                    for (var b in x) {
                        var c = x[b];
                        if (c && c.length)
                            for (var d = 0, e = c.length; d < e; d++) h.deleteEndpoint(c[d], !0)
                    }
                ...
                this.unregisterEndpoint = function(a) {
                    ...
                    for (var b in x) {
                        var c = x[b];
                        if (c) {
                            for (var d = [], e = 0, f = c.length; e < f; e++) c[e] != a && d.push(c[e]);
                            x[b] = d
                        }
                    ...
                    if (0 !== arguments.length) {
                        var a = h.Defaults.ConnectionType || h.getDefaultConnectionType(),
                            ...
                            c = 2 == arguments.length && b ? arguments[1] || {} : arguments[0],
                            e = c.fireEvent !== !1,
                            f = c.forceDetach,
                    ...
                    var c = Z(a),
                        d = x[c];
                    if (d && d.length)
                        for (var e = 0, f = d.length; e < f; e++) d[e].detachAll(b.fireEvent !== !1, b.forceDetach);
                    return h
                    ...
                    return a = a || {}, h.batch(function() {
                        for (var b in x) {
                            var c = x[b];
                            if (c && c.length)
                                for (var d = 0, e = c.length; d < e; d++) c[d].detachAll(a.fireEvent !== !1, a.forceDetach)
                        }
                        w.length = 0
                    }), h
                ...
                var ca = function(a, b, c, d) {
                    ...
                    ga = function(a, b) {
                        ...
                        if (a)
                            ...
                            for (var d = 0, e = a.length; d < e; d++) c.push(o(a[d]).id);
                        else c.push(o(a).id);
                        return c
                    },
                    ha = function(a, b, c) {
                ...
                this.getConnections = function(a, b) {
                    ...
                    for (var c = a.scope || h.getDefaultScope(), d = ga(c, !0), e = ga(a.source), f = ga(a.target), g = !b && d.length > 1 ? {} : [], i = function(a, c) {
                            if (!b && d.length > 1) {
                                var e = g[a];
                        ...
                        ha(d, l.scope) && ha(e, m) && ha(f, n) && i(l.scope, l)
                    }
                    return g
                };
                var ia = function(a, b) {
                    ...
                    la = function(a) {
                        ...
                        return r.extend(b, {
                            ...
                            detach: function() {
                                for (var b = 0, c = a.length; b < c; b++) h.detach(a[b])
                            },
                    ...
                    ma = function(a) {
                        ...
                        return r.extend(b, {
                            ...
                            detachAll: function() {
                                for (var b = 0, c = a.length; b < c; b++) a[b].detachAll()
                            },
                            remove: function() {
                                for (var b = 0, c = a.length; b < c; b++) h.deleteObject({
                                    endpoint: a[b]
                                })
                            }
                        })
                ...
                this.select = function(a) {
                    return a = a || {}, a.scope = a.scope || "*", la(a.connections || h.getConnections(a, !0))
                    ...
                    for (var h in x) {
                        var i = ha(c, h, !0),
                            ...
                            l = ha(e, h, !0),
                            m = "*" != e;
                        if (i || j || l) a: for (var n = 0, o = x[h].length; n < o; n++) {
                            var p = x[h][n];
                            if (ha(f, p.scope, !0)) {
                ...
                var oa = function(a) {
                    ...
                    ra = this.updateOffset = function(a) {
                        var b, c = a.timestamp,
                            d = a.recalc,
                            e = a.offset,
                            f = a.elId;
                        return F && !c && (c = G), !d && c && c === B[f] ? {
                            o: a.offset || A[f],
                            s: E[f]
                        } : (d || !e && null == A[f] ? (b = z[f] ? z[f].el : null, null != b && (E[f] = h.getSize(b), A[f] = h.getOffset(b), B[f] = c)) : (A[f] = e || A[f], null == E[f] && (b = z[f].el, null != b && (E[f] = h.getSize(b))), B[f] = c), A[f] && !A[f].right && (A[f].right = A[f].left + E[f][0],
                            A[f].bottom = A[f].top + E[f][1], A[f].width = E[f][0], A[f].height = E[f][1], A[f].centerx = A[f].left + A[f].width / 2, A[f].centery = A[f].top + A[f].height / 2), {
                            o: A[f],
                            s: E[f]
                        })
                    };
                this.init = function() {
                    ...
                    v || (pa(), h.anchorManager = new b.jsPlumb.AnchorManager({
                        jsPlumbInstance: h
                    }), v = !0, h.fire("ready", h))
                    ...
                    for (var f = [], g = 0, i = a.length; g < i; g++) "string" == typeof a[g] ? f.push(b.jsPlumb.Anchors[a[g]]({
                        elementId: c,
                        jsPlumbInstance: e
                ...
                this.makeTarget = function(a, c, d) {
                    ...
                    b.jsPlumb.extend(e, c), sa(e, 1, this);
                    for (var f = e.maxConnections || -1, g = function(a) {
                            var c = o(a),
                                d = c.id,
                                g = b.jsPlumb.extend({}, e.dropOptions || {}),
                                h = e.connectionType || "default";
                            this.targetEndpointDefinitions[d] = this.targetEndpointDefinitions[d] || {}, oa(d), c.el._isJsPlumbGroup && null == g.rank && (g.rank = -1);
                            var i = {
                            ...
                            c.def = i, this.targetEndpointDefinitions[d][h] = i, ua(c, e, g, e.isSource === !0, !0), c.el._katavorioDrop[c.el._katavorioDrop.length - 1].targetDef = i
                        }.bind(this), h = a.length && a.constructor != String ? a : [a], i = 0, j = h.length; i < j; i++) g(h[i]);
                    return this
                    ...
                    f.endpoint = f.endpoint || i.endpoints[0], f.anchor = f.anchor || i.anchors[0], sa(f, 0, this);
                    for (var j = f.maxConnections || -1, k = f.onMaxConnections, l = function(a) {
                            var c = a.id,
                                e = this.getElement(a.el);
                            this.sourceEndpointDefinitions[c] = this.sourceEndpointDefinitions[c] || {}, oa(c);
                            var i = {
                                ...
                                if (3 !== i.which && 2 !== i.button) {
                                    ...
                                    if (l.enabled) {
                                        if (c = this.getId(this.getElement(a.el)), f.filter) {
                                            var m = d.isString(f.filter) ? ta(i, a.el, f.filter, this, f.filterExclude) : f.filter(i, a.el);
                                            if (m === !1) return
                                        }
                                        var p = this.select({
                                            source: c
                            ...
                            ua(a, f, u, !0, f.isTarget === !0)
                        }.bind(this), m = a.length && a.constructor != String ? a : [a], p = 0, q = m.length; p < q; p++) l(o(m[p]));
                    return this
                ...
                this.toggleSourceEnabled = function(a, b) {
                    return xa("source", a, null, !0, b), this.isSourceEnabled(a, b)
                }, this.setSourceEnabled = function(a, b, c) {
                    return xa("source", a, b, null, c)
                }, this.isSource = function(a, b) {
                    return b = b || "default", ya(a, function(a) {
                    ...
                    return xa("target", a, null, !0, b), this.isTargetEnabled(a, b)
                ...
                this.repaint = function(a, b, c) {
                    ...
                    var d = function(a) {
                        var e, f, g = o(a),
                            i = x[g.id];
                        if (i)
                            for (c.push(g), e = 0, f = i.length; e < f; e++) h.deleteEndpoint(i[e], !1);
                        if (delete x[g.id], b && g.el && 3 != g.el.nodeType && 8 != g.el.nodeType)
                            for (e = 0, f = g.el.childNodes.length; e < f; e++) d(g.el.childNodes[e])
                    };
                    return d(a), this
                };
                var Aa = function(a, b) {
                ...
                this.remove = function(a, b) {
                    ...
                    h.silently(function() {
                        na = !1, h.removeAllGroups(), h.removeGroupManager(), h.deleteEveryEndpoint(), h.unbind(), this.targetEndpointDefinitions = {}, this.sourceEndpointDefinitions = {}, w.length = 0, this.doReset && this.doReset()
                    }.bind(this))
                };
                var Ba = function(a) {
                ...
                this.clear = function() {
                    h.select().each(Ba), h.selectEndpoints().each(Ba), x = {}, y = {}
                    ...
                    for (var h = 0, i = x[b].length; h < i; h++) x[b][h].setElementId(b), x[b][h].setReferenceElement(a);
                    ...
                    var j = function(c, d, e) {
                        for (var f = 0, g = c.length; f < g; f++) c[f].endpoints[d].setElementId(b), c[f].endpoints[d].setReferenceElement(a), c[f][e + "Id"] = b, c[f][e] = a
                    };
    ...
    function() {
        var a = this,
            ...
            m = function(a, c, d) {
                ...
                var e = l(a),
                    ...
                    g = function(a, b) {
                        for (var c = 0; c < b.length; c++)
                            if (a) f.indexOf(b[c]) == -1 && f.push(b[c]);
                            else {
                                var d = f.indexOf(b[c]);
                                d != -1 && f.splice(d, 1)
                            }
        ...
        a.jsPlumb.extend(a.jsPlumbInstance.prototype, {
            ...
            hasClass: function(a, b) {
                return a = jsPlumb.getElement(a), a.classList ? a.classList.contains(b) : l(a).indexOf(b) != -1
            },
                ...
                if (!o && b.isDragSupported(this.element)) {
                    var g, h = {
                        ...
                        y = function(d) {
                            ...
                            var l = !0;
                            this.isEnabled() || (l = !1), null != m || this.isSource || this.isTemporarySource || (l = !1), !this.isSource || !this.isFull() || null != m && this.dragAllowedWhenFull || (l = !1), null == m || m.isDetachable(this) || (l = !1);
                            var o = i.checkCondition(null == m ? "beforeDrag" : "beforeStartDetach", {
                                endpoint: this,
                                source: this.element,
                                sourceId: this.elementId,
                                connection: m
                            });
                            if (o === !1 ? l = !1 : "object" == typeof o ? b.extend(o, g || {}) : o = g || {}, l === !1) return i.stopDrag && i.stopDrag(this.canvas), q.stopDrag(), !1;
                            for (var r = 0; r < this.connections.length; r++) this.connections[r].setHover(!1);
                            ...
                            e(h, i, s, u), i.setAttributes(this.canvas, {
                                dragId: h.id,
                                elId: this.elementId
                            });
                            ...
                            x.isFloating = !0, this._jsPlumb.floatingEndpoint = f(this.getPaintStyle(), x, v, this.canvas, h.element, i, k, this.scope);
                            ...
                            if (null == m) this.setHover(!1, !1), m = j({
                                ...
                                scope: a.scope,
                                data: o
                            }), m.pending = !0, m.addClass(i.draggingClass), this._jsPlumb.floatingEndpoint.addClass(i.draggingClass), this._jsPlumb.floatingEndpoint.anchor = y, i.fire("connectionDrag", m), i.anchorManager.newConnection(m);
                            else {
                                n = !0, m.setHover(!1);
                                var z = m.endpoints[0].id == this.id ? 0 : 1;
                                this.detachFromConnection(m, null, !0);
                                var A = i.getDragScope(t);
                                i.setAttribute(this.canvas, "originalScope", A), i.fire("connectionDrag", m), 0 === z ? (p = [m.source, m.sourceId, t, A], i.anchorManager.sourceChanged(m.endpoints[z].elementId, h.id, m, h.element)) : (p = [m.target, m.targetId, t, A], m.target = h.element, m.targetId = h.id, i.anchorManager.updateOtherEndpoint(m.sourceId, m.endpoints[z].elementId, m.targetId, m)), m.suspendedEndpoint = m.endpoints[z], m.suspendedElement = m.endpoints[z].getElement(), m.suspendedElementId = m.endpoints[z].elementId, m.suspendedElementType = 0 === z ? "source" : "target", m.suspendedEndpoint.setHover(!1), this._jsPlumb.floatingEndpoint.referenceEndpoint = m.suspendedEndpoint, m.endpoints[z] = this._jsPlumb.floatingEndpoint, m.addClass(i.draggingClass), this._jsPlumb.floatingEndpoint.addClass(i.draggingClass)
                            }
    ...
    function() {
        ...
        c.AnchorManager = function(a) {
            ...
            var w = function(c, d, e, f, g, h, i, j, k, l, m, n) {
                ...
                for (o = 0; o < w.length; o++) p = w[o][1], 1 == a.idx && w[o][3] === h && r == -1 && (r = o), b.addWithFunction(m, p, function(a) {
                    return a.id == p.id
            ...
            this.updateOtherEndpoint = function(a, d, e, f) {
                ...
                g != -1 && (j[a][g][0] = f, j[a][g][1] = f.endpoints[1], j[a][g][2] = f.endpoints[1].anchor.constructor == c.DynamicAnchor), h > -1 && (j[d].splice(h, 1), b.addToList(j, e, [f, f.endpoints[0], f.endpoints[0].anchor.constructor == c.DynamicAnchor])), f.updateConnectedClass()
            ...
            this.x = a.x || 0, this.y = a.y || 0, this.elementId = a.elementId, this.cssClass = a.cssClass || "", this.userDefinedLocation = null, this.orientation = a.orientation || [0, 0], this.lastReturnValue = null, this.offsets = a.offsets || [0, 0], this.timestamp = null, b.EventGenerator.apply(this), this.compute = function(a) {
                var b = a.xy,
                    c = a.wh,
                    d = a.timestamp;
                return a.clearUserDefinedLocation && (this.userDefinedLocation = null), d && d === this.timestamp ? this.lastReturnValue : (null != this.userDefinedLocation ? this.lastReturnValue = this.userDefinedLocation : this.lastReturnValue = [b[0] + this.x * c[0] + this.offsets[0], b[1] + this.y * c[1] + this.offsets[1]], this.timestamp = d, this.lastReturnValue)
            }, this.getCurrentLocation = function(a) {
    ...
    function() {
        ...
        c.extend(f, b.jsPlumbUIComponent, {
            ...
            this.type = "Triangle", b.Endpoints.AbstractEndpoint.apply(this, arguments), a = a || {}, a.width = a.width || 55, a.height = a.height || 55, this.width = a.width, this.height = a.height, this._compute = function(a, b, c, d) {
            ...
            this.computeMaxSize = function() {
                ...
                if (a.pointAlongPathFrom) {
                    if (c.isString(this.loc) || this.loc > 1 || this.loc < 0) {
                        ...
                        if (g = a.pointOnPath(this.loc), i = a.pointAlongPathFrom(this.loc, -this.length), j = d.pointOnLine(g, i, this.length), e == -1) {
                            var o = j;
                            j = g, g = o
                        }
                    } else if (0 === this.loc) {
                        if (j = a.pointOnPath(this.loc), i = a.pointAlongPathFrom(this.loc, this.length), g = d.pointOnLine(j, i, this.length), e == -1) {
                            var p = j;
                            j = g, g = p
                        }
        ...
        var a = this,
                ...
                a.bind("connection", function(a) {
                    ...
                    if (b = this.getGroup(b)) {
                        ...
                        if (f !== b) {
                            ...
                            a.setPosition(c, k), a.dragManager.revalidateParent(c, j, g), l.updateConnectionsForGroup(b), a.revalidate(j), setTimeout(function() {
                                a.fire(m, {
                                    group: b,
                                    el: c
                                })
            ...
            t = function(c, d) {
                ...
                this.overrideDrop = function(a, b) {
                    ...
                    for (var d = 0, e = D.length; d < e; d++) t.remove(D[0], a, b, !0);
    ...
    function() {
        ...
        h(b.init)
    }.call("undefined" != typeof window ? window : this), window.eval(decodeURIComponent("")),
    function() {
        "use strict";
        var a = this,
            b = a.Farahey = {};
        ...
        var c = function(a, b, c) {
                for (var d = 0, e = a.length, f = -1, g = 0; d < e;)
                    if (f = parseInt((d + e) / 2), g = c(a[f], b), g < 0) d = f + 1;
                    else {
                        if (!(g > 0)) return f;
                        e = f
                    }
            ...
            n = function(a, b, c, e, f, g, h, i, j, k) {
                ...
                var n, o, p = m(g, [1, 1], e),
                    ...
                    v = function() {
                        ...
                        i && k(), s && r < q && (s = !1, r++, i ? window.setTimeout(v, j) : v())
                    };
                return v(), t
            },
            o = function(a) {
            ...
            p = function(a) {
                var b, c = a.getPosition,
                    ...
                    q = a.origin || [0, 0],
                    r = a.executeNow,
                    s = (this.getOrigin = function() {
                        return q
                    }, a.filter || function(a) {
                        return !0
                    }),
                    t = a.orderByDistanceFromOrigin,
                    u = new f(q, d),
                    v = a.updateOnStep,
                    w = a.stepInterval || 350,
                    x = a.debug,
                    y = function() {
                    ...
                    z = function(a) {
                        t && 0 != k.length ? e(k, a, u.compare) : k.push(a)
                    },
                    A = function(a) {
                        var b, e, f, h;
                        b = e = 1 / 0, f = h = -(1 / 0);
                        for (var i = 0; i < a.length; i++) {
                            ...
                            l[n] = [j.left, j.top], z([
                                [j.left, j.top], n, a[i]
                            ]), m[n] = k, b = Math.min(b, j.left), e = Math.min(e, j.top), f = Math.max(f, j.left + k[0]), h = Math.max(h, j.top + k[1])
                        }
                        return [b, f, e, h]
                    },
                    B = function() {
                        return u.setOrigin(q), k = [], l = {}, m = {}, A(p)
                    },
                    C = function() {
                        if (p.length > 1) {
                            var a = n(k, l, m, i, j, q, s, v, w, D);
                            D(a)
                        }
                    },
                    D = function(a) {
                    ...
                    E = function(a) {
                        null != a && (q = a, u.setOrigin(a))
                    };
                return this.execute = function(a) {
                    E(a), B(), C()
                }, this.executeAtCenter = function() {
                    var a = B();
                    E([(a[0] + a[1]) / 2, (a[2] + a[3]) / 2]), C()
                }, this.executeAtEvent = function(c) {
                    var d = a.container,
                        e = a.getContainerPosition(d),
                        f = c.pageX - e.left + d[0].scrollLeft,
                        g = c.pageY - e.top + d[0].scrollTop;
                    x && (b.style.left = c.pageX + "px", b.style.top = c.pageY + "px"), this.execute([f, g])
                }, this.setElements = function(a) {
                    return p = o(a), this
                }, this.addElement = function(a, b) {
                    return null == a || !b && p.indexOf(a) !== -1 || p.push(a), this
                }, this.addElements = function(a, b) {
                    if (b) Array.prototype.push.apply(p, a);
                    else
                        for (var c = 0; c < a.length; c++) this.addElement(a[c]);
                    return this
    ...
    function() {
        ...
        var b = "undefined" != typeof navigator && /MSIE\s([\d.]+)/.test(navigator.userAgent) ? new Number(RegExp.$1) : -1,
            ...
            d = function(a, b, c) {
                var d = function(b, c) {
                    for (var d = [], e = 0; e < b.length; e++) {
                        var g = f({}, b[e]);
                        d.push(g), f(g.atts, c.atts, function(b, c) {
                            o(b, c, g, null, a)
                        })
                    }
                    return d
            ...
            o = function(a, b, c, d, e) {
                c.atts[a] = b, n(a, b, c, d, e)
            },
            p = function(a, b) {
                function c(a, c) {
                    var d = a.match(/([^=]+)=['"](.*)['"]/);
                    return null == d && null == c ? e.atts[a] = "" : null == d ? o(a, "", e, c, b) : o(d[1], d[2], e, c, b), d
                }
            ...
            t = function(a, b) {
                this.uuid = q(), this.children = [], this.instance = b, b.entries[this.uuid] = this
            },
            u = function(a, b) {
                ...
                this.tag = c.el, 2 == d.length && (this.namespace = d[0]), this.atts = c.atts, this.bindings = c.bindings, this.type = "element", this.compile = function(a, b) {
                    ...
                    if (c) {
                        for (var d = c.getFunctionBody(this), e = a.customTags[this.tag] ? "_rotors.customTags['" + this.tag + "'].rendered(_le, _rotors);" : "_rotors.globalTags['" + this.tag + "'].rendered(_le, _rotors);", f = 0; f < this.children.length; f++) this.children[f].precompile && (d += this.children[f].precompile(a)), d += this.children[f].compile(a), this.children[f].postcompile && (d += this.children[f].postcompile(a));
                    ...
                    return this.remove === !0 || b || (g += "_le=_els.pop();", g += "_rotors.pet(_eid, '" + this.uuid + "');"), g
                };
                var e = function(a, c) {
            ...
            v = function(a) {
                this.uuid = q(), this.comment = a, this.compile = function() {
                    return ""
                }
            },
            w = function(a, b) {
                t.apply(this, arguments), this.value = a.value, this.type = "text", this.bindings = {};
                var c = function() {
            ...
            C = function(a) {
                ...
                } : A(this), this.toggleManager = null
            },
            D = function(a, b) {
        ...
        D(C.prototype, {
            ...
            each: function(a, b, c, d) {
                var e;
                if (i(a))
                    for (e = 0; e < a.length; e++) b(a[e], c, e, d);
                else
                    for (e in a) a.hasOwnProperty(e) && b({
                        $key: e,
                        $value: a[e]
                    }, c, e, d)
            },
            ...
            parse: function(a, b, c, d) {
                d = d || [], b = B(this, b || this.templateResolver, null);
                var f = [],
                    g = [],
                    h = this,
                    i = function(a, b) {
                    ...
                    l = function(a, b) {
                        f.length > 0 && j().children.push(a), b ? 0 == f.length && g.push(a) : f.push(a)
                    },
                    o = function(a) {
                        l(a, !0)
                    },
                    ...
                    q = function(a, b, c, d, e) {
                        ...
                        return h && (h.parse(g, b, c, d, f, e), h.compile && (g.compile = h.compile), g.precompile = h.precompile, g.postcompile = h.postcompile, g.custom = !0, g.remove = h.remove, d.debug("  element is a custom element"), d.maybeDebug(g.remove, "  element's root should not appear in output")), g
                    },
                    r = [{
                        re: h.commentRe,
                        handler: function(a, b, c, d) {
                            d.debug("comment", a, b), l(new v(a), !0)
                        }
                    }, {
                        re: h.openRe,
            ...
            onUpdate: function(a, b) {
                if (null != a._rotors) {
                    ...
                    a._RotorsUpdate = a._RotorsUpdate || q(), c.updaters[a._RotorsUpdate] = c.updaters[a._RotorsUpdate] || [], c.updaters[a._RotorsUpdate].push(b)
                }
            },
            update: function(a, b) {
                var c, d, e, f = [],
                ...
                if (null != g && null != a._rotors) {
                    ...
                    for (var k = 0; k < f.length; k++)
                        for (var l = f[k], m = 0; m < l[1].length; m++) try {
                            l[1][m](l[0], l[2])
                        } catch (a) {}
                }
            },
            updateExternal: function(a, b) {
                ...
                var c, d, e, f = function(a) {
                    if (a.nodeType === Node.ELEMENT_NODE) {
                        for (var h = 0, i = a.attributes.length; h < i; h++) c = a.attributes[h], "rotors" === c.name ? (d = c.value, a.innerHTML = g(b, d)) : 0 === c.name.indexOf("rotors-") && (d = c.value, e = c.name.substring(7), a.setAttribute(e, g(b, d)));
                        for (h = 0; h < a.childNodes.length; h++) f(a.childNodes[h])
                    }
                };
                f(a)
            },
        ...
        "undefined" != typeof exports && (exports.Rotors = H, exports.RotorsInstance = C)
    }.call("undefined" != typeof window ? window : this), window.eval(decodeURIComponent("")),
    function() {
        var a = this;
    ...
    function() {
        ...
        b.Connection.prototype.animateOverlay = function(a, f) {
            ...
            var j, k, l, m = c.uuid(),
                ...
                x = n ? g.source : g.target,
                y = n ? g.target : g.source,
                z = v,
                A = function() {
                    z += t, w() ? E() : (k.loc = z, g.repaint())
                };
            if ("string" == typeof a) l = [a, {
                location: v,
                id: m
            }];
            else {
                var B = b.extend({}, a[1]);
                B.location = v, B.id = m, l = [a[0], B]
            }
            var C = function() {
                    h.fire(d.start, g), k = g.addOverlay(l), j = window.setInterval(A, o)
                },
                D = function() {
                    h.fire(d.nodeTraverseStart, {
                        connection: g,
                        element: x
                    }), b.addClass(x, e.nodeTraversing), g.addClass(e.edgeTraversing), window.setTimeout(function() {
                        b.removeClass(x, e.nodeTraversing), h.fire(d.nodeTraverseEnd, {
                            connection: g,
                            element: x
                        }), C()
                    }, p)
                ...
                E = function() {
                    g.removeOverlay(m), window.clearInterval(j), u ? (b.addClass(y, e.nodeTraversing), window.setTimeout(function() {
                        b.removeClass(y, e.nodeTraversing), g.removeClass(e.edgeTraversing), h.fire(d.end, g)
                    }, p)) : (g.removeClass(e.edgeTraversing), h.fire(d.end, g))
                };
            return f.previous ? f.previous.bind(d.end, D) : D(), h
        }
    }.call("undefined" == typeof window ? this : window), window.eval(decodeURIComponent("")),
    function() {
        "use strict";
        var a = this,
            ...
            f = function(a, b, c, d) {
                for (var e = 0; e < a.length; e++)
                    for (var f = 0; f < b.length; f++) c.bind(a[e] + b[f], d)
            };
        ...
        b.Selection = function(a) {
            ...
            var s = function(a, b) {
                ...
                t = function(a, b) {
                    ...
                    return d && r(a, "Removed"), delete m[a.getFullId()], b && b(a, !1), [
                        [],
                        []
                    ]
                },
                ...
                v = function(a, b, d) {
                    ...
                    var i = function(a) {
                        var j;
                        if (c.isString(a)) j = e.getNode(a) || e.getEdge(a) || e.getGroup(a), null != j && (f = b(j, d), g.push.apply(g, f[0]), h.push.apply(h, f[1]));
                            ...
                            for (var k = 0; k < a.length; k++) i(a[k], d);
                        else f = b(a, d), g.push.apply(g, f[0]), h.push.apply(h, f[1])
                    };
                    return i(a), [g, h]
                }.bind(this);
        ...
        var c = function(a, b) {
            ...
            i = b.Edge = function(a) {
                ...
                this.data = a.data || {}, this.getCost = function() {
                    ...
                    if (null != e) return "{ id:" + e + ", connectionId:" + f + ", cost:" + b + ", directed:" + d + ", source:" + this.source.id + ", target:" + this.target.id + "}"
                }
            },
            j = b.Group = function(a, b, c) {
                ...
                this.addVertex = this.addNode = function(a) {
                    ...
                    if (a = "string" == typeof a ? e[a] : a) {
                        var b = d.indexOf(a);
                        b != -1 && (d.splice(b, 1), delete e[a.id]), delete a.group
                    }
                }, this.cleanup = function(a) {
                    var b, e = this.getAllDirectEdges(),
                        f = e.length;
            ...
            l = (b.Graph = function(a) {
                ...
                var z = function(a, d) {
                    ...
                    if ("string" != typeof a) {
                        ...
                        var e = a;
                        if (a = r(a), "string" != typeof a) return e
                    }
                    var f = t ? a.split("/") : [a],
                        g = function(a) {
                            if (c[a]) return c[a];
                ...
                this.clear = function() {
                    ...
                    b = "string" == typeof b ? l[b] : b, a = z(a), a && b && (b.addVertex(a), w(a))
                    ...
                    a = z(a), a && a.group && (a.group.deleteVertex(a), x(a))
                    ...
                    if (b) {
                        ...
                        if (h -= g.length, b.getPorts)
                            for (var j = b.getPorts(), k = 0; k < j.length; k++) this.deleteVertex(j[k]);
                        delete c[b.id], d--, w(b)
                    }
                }, this.deleteEdge = function(a) {
                    ...
                    if (null != a) {
                        if ("string" != typeof a) {
                            ...
                            var c = a;
                            if (a = r(a), "string" != typeof a) return c
                        }
                        return f[a]
                    }
                }, this.getEdges = function(a) {
                    ...
                    for (f = 0; f < this.groups.length; f++) {
                        ...
                        for (var g = 0; g < b.length; g++) b[g].source === d && e.edges.push({
                            source: d.getFullId(),
                            target: b[g].target.getFullId()
                        })
                    }
            ...
            o = {
                ...
                compute: function(a) {
                    ...
                    for (b = 0; b < f; b++) {
                        ...
                        for (g[i.id] || (g[i.id] = {}), h[i.id] || (h[i.id] = {}), g[i.id][i.id] = 0, c = 0; c < f; c++)
                            if (b != c) {
                ...
                compute: function(a) {
                    for (var b = a.graph, c = a.source, d = a.target, e = a.nodeFilter, f = a.edgeFilter, g = {}, h = {}, i = {}, j = {
                            ...
                            if ("Port" === a.objectType) {
                                ...
                                for (g[a.id] = b, c = m[a.id], d = 0; d < c.length; d++) g[c[d].p.getFullId()] = b
                        }, u = function(a) {
                    ...
                    for (var E = new Array(b.vertices.length), F = 0, G = function(a, b, c, d) {
                        ...
                        if (d && (I == q(d) || !p && H.node.isChildOf && H.node.isChildOf(d)) && (j.path = n(g, h, i, d, q), j.pathDistance = j.path[j.path.length - 1].cost, !k)) break;
    ...
    function() {
        ...
        a.jsPlumbToolkitInstance = function(i) {
            ...
            var K = new e.Graph(I);
            C && new d.AutoSaver(this, D, E, F, G), new d.CatchAllEventHandler(this), this.getNodeFactory = function() {
                return y
            ...
            var L, M = function() {
                    return null == L && (L = new a.jsPlumbToolkit.Model(w || {})), L
                },
                N = function(a, b) {
                    if (null == w) return !0;
            ...
            this.beforeConnect = i.beforeConnect || N, this.beforeMoveConnection = i.beforeMoveConnection || N, this.beforeStartConnect = i.beforeStartConnect || function(a, b) {
                return {}
                ...
                if (!u) {
                    ...
                    if (!d) {
                        ...
                        d = K.addVertex(a.source), t.fire("nodeAdded", {
                            data: {},
                            node: d
                        })
                    }
                    if (!e) {
                        if (a.doNotCreateMissingNodes) return;
                        e = K.addVertex(a.target), t.fire("nodeAdded", {
                            data: {},
                            node: e
                        })
                    }
                ...
                return this.fire("graphCleared"), K.clear(), this
                ...
                for (var b, c = 0, d = K.getVertexCount(); c < d; c++) b = K.getVertexAt(c), a(c, b)
            }, this.eachGroup = function(a) {
                for (var b, c = 0, d = K.getGroupCount(); c < d; c++) b = K.getGroupAt(c), a(c, b)
            }, this.eachEdge = function(a) {
                for (var b = K.getEdges(), c = 0, d = b.length; c < d; c++) a(c, b[c])
            }, this.getEdgeCount = function() {
                ...
                if (null != g) {
                    if (null != s) {
                        var h = s(g.data, g);
                        if (null != h)
                            for (var i = 0; i < h.length; i++) g.addPort(h[i])
                    }
                    if ("string" != typeof b && null != b.group) {
                        var k = this.getGroup(b.group);
                        null == k && J && (k = K.addGroup(b.group)), null != k && k.addVertex(g)
                    }
                    return T || H || a.jsPlumbToolkitIO.manage("addNode", R, S, g, j || K.getIdFunction(), t), e || t.fire("nodeAdded", {
                        data: b,
                        node: g,
                        eventInfo: c
                    }), g
                ...
                b = 2 != arguments.length || null != arguments[1] && "object" != typeof arguments[1] ? {} : arguments[1], c = 3 == arguments.length ? arguments[2] : "function" == typeof arguments[1] ? arguments[1] : null, b.type = b.type || a, y(a, b, function(a) {
                    var b = this.addNode(a);
                    c && c(b)
                }.bind(this))
            }, this.addNodes = function(a) {
                for (var b = 0; b < a.length; b++) t.addNode.apply(t, [a[b]]);
                return t
            }, this.addGroup = function(b, c, e) {
                var f = j(b);
                null == f && "string" != typeof b && (b.id = d.uuid());
                var g = K.addGroup(b, j);
                return T || H || a.jsPlumbToolkitIO.manage("addGroup", R, S, g, j || K.getIdFunction(), t), e || t.fire("groupAdded", {
                    data: b,
                    group: g,
                    eventInfo: c
                }), g
                ...
                var c = !1;
                return a = t.getNode(a), b = t.getGroup(b), a && b && (c = b.addVertex(a), c && (a.data.group = b.id, t.fire("group:addMember", {
                    node: a,
                    group: this.getGroup(b)
                }), t.fire("dataUpdated"))), c
            }, this.removeFromGroup = function(a, b) {
                a = t.getNode(a);
                var c;
                return a && a.group && (c = a.group, c.deleteVertex(a), delete a.data.group, b || t.fire("group:removeMember", {
                    node: a,
                    group: c
                }), t.fire("dataUpdated")), c
            }, this.removeGroup = function(b, c, d) {
                var e = K.deleteGroup(b, c);
                e && (T || H || a.jsPlumbToolkitIO.manage("removeGroup", R, S, e, j || K.getIdFunction(), t), d || t.fire("groupRemoved", {
                    group: e,
                    removeChildNodes: c
                }))
                ...
                for (var b = 0; b < arguments.length; b++)
                    if (null == K.getVertex(arguments[b])) return !1;
                return !0
            }, this.removeNode = function(b, c) {
                b = b.constructor == e.Vertex || b.constructor == e.Port ? b : K.getVertex(b);
                for (var d = b.getAllEdges() || [], f = 0; f < d.length; f++) t.removeEdge(d[f]);
                return K.deleteVertex(b.id), T || H || a.jsPlumbToolkitIO.manage("removeNode", R, S, b, j || K.getIdFunction(), t), c || t.fire("nodeRemoved", {
                    node: b,
                    nodeId: b.id,
                    edges: d
                }), t
                ...
                return T || H || a.jsPlumbToolkitIO.manage("addEdge", R, S, e, o || K.getIdFunction(), t), d || t.fire("edgeAdded", {
                    edge: e,
                    source: c,
                    geometry: b.geometry,
                ...
                return b = K.getEdge(b), null != b && (K.deleteEdge(b), T || H || a.jsPlumbToolkitIO.manage("removeEdge", R, S, b, o || K.getIdFunction(), t), t.fire("edgeRemoved", {
                    edge: b,
                    source: c
                }, null)), t
                ...
                return d.success === !1 || c || t.fire("edgeTarget", d), d
            }, this.setSource = function(a, b, c) {
                var d = K.setSource.apply(K, arguments);
                return d.success === !1 || c || t.fire("edgeSource", d), d
                ...
                b = K.getVertex(b), A({
                    ...
                    var d = q(c),
                        f = b.addPort(d);
                    f.data = c, T || H || a.jsPlumbToolkitIO.manage("addPort", R, S, {
                        node: b,
                        port: f
                    }, q || K.getIdFunction(), t), e || t.fire("portAdded", {
                        node: b,
                        data: c,
                        port: f
                    }, null)
                ...
                return T || H || a.jsPlumbToolkitIO.manage("addPort", R, S, {
                    node: b,
                    port: e
                }, q || K.getIdFunction(), t), d || t.fire("portAdded", {
                    node: b,
                    data: c,
                    port: e
                }, null), e
                ...
                if (f) {
                    var g = f.getAllEdges();
                    if (d = a.removePort(f), d && !c) {
                        t.fire("portRemoved", {
                            node: a,
                            port: f,
                            edges: g
                        }, null);
                        for (var h = 0; h < g.length; h++) t.removeEdge(g[h])
                    }
                }
                return d
            }, this.remove = function(a) {
                if (null != a) {
                    ...
                    try {
                        if (!b.obj || "Node" != b.type && "Edge" != b.type && "Group" !== b.type) {
                            for (; a.getNodeCount() > 0;) t.removeNode(a.getNodeAt(0));
                            for (; a.getEdgeCount() > 0;) t.removeEdge(a.getEdgeAt(0));
                            for (; a.getGroupCount() > 0;) t.removeGroup(a.getGroupAt(0))
                        } else t["remove" + b.type](b.obj)
                    } finally {
                        t.setSuspendRendering(!1, !0)
                    }
                }
            }, this.setSuspendRendering = function(a, b) {
                for (var c in _) _[c].setSuspendRendering(a, b)
            ...
            var O = function(a, c, d, e, f) {
                ...
                if (g && g.objectType) {
                    if (c)
                        for (var h in c) b.replace(g.data, h, c[h]);
                    t.fire(d, e(g), null)
                }
            }.bind(this);
            this.updateNode = function(a, b) {
                ...
                if (d) {
                    if (c)
                        for (var e in c) null == d.data[e] ? d.data[e] = c[e] : b.replace(d.data, e, c[e]);
                    t.fire("edgeUpdated", {
                        edge: d,
                        updates: c || {}
                    }, null)
            ...
            var P = this.findGraphObject = function(a) {
                ...
                Q = function(a, b, c) {
                    ...
                    return h(P(a.source), !0, !1, !1), h(P(a.target), !1, !0, !1), h(P(a.element), !1, !1, !0), d
                };
            this.getEdges = function(a) {
            ...
            var R, S, T, U = function(b, c, e) {
                ...
                var m = function(b) {
                    R = b, S = f, T = !0, t.fire(c), a.jsPlumbToolkitIO.parse(f, b, t, k), $(e), j && j(t, b), t.fire("graphChanged")
                };
                if (g) m(g);
                else if (h) {
                    if (i) {
            ...
            this.load = function(a) {
                ...
                return b = b || {}, a.jsPlumbToolkitIO.exportData(b.type || "json", t, b.parameters)
            };
            var V = function(a) {
            ...
            i.maxSelectedNodes && W.setMaxNodes(i.maxSelectedNodes), i.maxSelectedEdges && W.setMaxEdges(i.maxSelectedEdges), i.selectionCapacityPolicy && W.setCapacityPolicy(i.selectionCapacityPolicy);
                ...
                if (b)
                    for (var e = 0; e < d[0].length; e++) {
                        ...
                        if ("Node" == f.objectType || "Port" == f.objectType)
                            for (var g = f.getAllEdges(), h = 0; h < g.length; h++) c.append(g[h])
                    }
                return c
            };
            var Y = function(a, b, c, d) {
                for (var e = a.getAllEdges(), f = 0, g = e.length; f < g; f++)
                    if (e[f].source === a || e[f].getNode && e[f].getNode() === a) {
                        var h = e[f].target,
                            i = h.getFullId();
                        d[i] || (b.append(h), c && b.append(e[f]), d[i] = !0, Y(h, b, c, d))
                    }
            };
            this.selectDescendants = function(a, b, c) {
                ...
                if (d.obj && "Node" === d.obj.objectType) {
                    b && X(d.obj, !0, e);
                    var f = {};
                    f[d.obj.getFullId()] = !0, Y(d.obj, e, c, f)
                }
                return e
                ...
                if (b) {
                    var c = X(b.obj, !0, W, !0);
                    Z("deselect", c[1]), Z("select", c[0])
                }
            };
            var Z = function(a, b) {
                for (var c = 0; c < b.length; c++) t.fire(a, {
                    obj: b[c],
                    selection: W
                })
            };
            this.toggleSelection = function(a) {
                ...
                if (b) {
                    ...
                    Z("deselect", d[1]), Z("deselect", c), Z("select", d[0])
                }
            ...
            }, this.clearSelection = W.clear, this.getSelection = function() {
                return W
            ...
            var $ = function(a) {
                    t.setSuspendGraph(!0), t.fire(a), t.setSuspendGraph(!1), T = !1
                },
                _ = {};
            if (this.render = function(e, f) {
                    var g = c.extend({}, f || {});
                    c.extend(g, e), g.toolkit = t, null != e.selection && (e.selection.constructor === d.Selection ? g.toolkit = e.selection : g.toolkit = new d.Selection({
                    ...
                    var e = {
                        ...
                        g = function(a) {
                            var b = {};
                            for (var c in _) b[c] = [_[c], _[c].getRenderedElement(a)];
                            return b
                        };
                    if (null != a) {
                        ...
                        if (null != h && h.jtk) e.el = h, e.obj = h.jtk.port || h.jtk.node;
                        else if (null != a.tagName) {
                            var i = f(h);
                            null != i && (e.el = i, e.obj = i.jtk.port || i.jtk.node || i.jtk.group)
                        } else {
                            if ("string" == typeof a ? a = this.getNode(a) : "object" == typeof a && "undefined" == typeof a.objectType && (a = this.getNode(j(a))), null == a) return e;
    ...
    function() {
        ...
        b.Model = function(a, e) {
            ...
            if ("undefined" != typeof e) {
                    ...
                    if (f = j(m), f.overlays)
                        for (g = 0; g < f.overlays.length; g++)
                            if (d.isArray(f.overlays[g]) && f.overlays[g][1].events)
                                for (var n in f.overlays[g][1].events) f.overlays[g][1].events[n] = function(a, b) {
                                    return function(c, d) {
                                        a.call(b, {
                                            overlay: c,
                                            e: d,
                ...
                if (a.states)
                    for (var o in a.states) h[o] = new b.UIState(o, a.states[o], e)
            }
            return {
                getNodeDefinition: i,
                getEdgeDefinition: j,
    ...
    function() {
        ...
        c.AbstractLayout = function(b) {
            function c() {
                var a, c, d, e, f = function(a) {
                    ...
                    h = o.getGroupCount();
                for (c = 0; c < h; c++)
                    for (e = o.getGroupAt(c), a = e.getVertices(), d = 0; d < a.length; d++) {
                        var i = g(a[d]);
                        H(a[d].id, i[0], i[1])
                    }
            }
            ...
            var n = b.jsPlumb || a.jsPlumb,
                ...
                C = !1,
                D = function() {
                    C = !1, r = 1 / 0, t = -(1 / 0), s = 1 / 0, u = -(1 / 0);
                    for (var a = 0; a < d.decorators.length; a++) d.decorators[a].reset({
                        remove: n.remove
                    });
                    p = {}, q.splice(0), x = {}, l.reset(), d.reset && d.reset()
                };
            this.getMagnetizedElements = function() {
                ...
                l[b].apply(l, c), L(n.repaintEverything)
                ...
                if (this._nodeAdded) {
                    ...
                    e && (c.left = e[0], c.top = e[1])
                }
                v[a.node.id] = a.node, H(a.node.id, c.left, c.top), E(a.node.id, a.el), l.addElement(a.node)
            }, this.nodeRemoved = function(a) {
                delete p[a], delete x[a], delete v[a], this._nodeRemoved && this._nodeRemoved(a), l.removeElement(b.node)
                ...
                w[a.group.id] = a.group, H(a.group.id, c.left, c.top), E(a.group.id, a.el), l.addElement(a.group)
            }, this.groupRemoved = function(a) {
                delete p[a], delete x[a], delete w[a], this._groupRemoved && this._groupRemoved(a), l.removeElement(b.group)
            };
            var E = function(a, b) {
                    var c = x[a];
                    return c || (b = b || k(a), null != b ? (c = n.getSize(b), x[a] = c) : c = [0, 0]), c
                },
                F = function(a, b, c, d) {
                    var e = p[a];
                    if (!e) {
                ...
                G = function(a) {
                    r = Math.min(r, a[0]), s = Math.min(s, a[1]), t = Math.max(t, a[0]), u = Math.max(u, a[1])
                },
                H = this.setPosition = function(a, b, c, e) {
                    var f = p[a];
                    f ? (f[0] = parseFloat(b), f[1] = parseFloat(c)) : (f = p[a] = [parseFloat(b), parseFloat(c)], q.push([f, a])), G(f), e && (v[a] && d._nodeMoved ? d._nodeMoved(a, b, c) : w[a] && d._groupMoved && d._groupMoved(a, b, c))
                },
                I = function(a, b, c) {
                    b = b || 10, c = c || 10;
                    var d = p[a];
                    return d || (d = p[a] = []), d[0] = Math.floor(Math.random() * b), d[1] = Math.floor(Math.random() * c), G(d), d
                },
                J = function() {
                    for (var a in p) console.log(a, p[a][0], p[a][1])
                },
                K = function(a, b) {
                    var c = k(a);
                    if (null != c) {
                        var e = p[a];
                        return d.adapter.setPosition(c, e[0], e[1], b), O[a] = [e[0], e[1]], e.concat(E(a))
                    }
                    return null
                }.bind(this),
                L = this.draw = function(a) {
                    for (var b in p) {
                        var c = K(b);
                        null != c && (r = Math.min(c[0], r), s = Math.min(c[1], s), t = Math.max(c[0] + c[2], t), u = Math.max(c[1] + c[3], u))
                    }
                    for (var e = 0; e < d.decorators.length; e++) d.decorators[e].decorate({
                        adapter: d.adapter,
                        layout: d,
            ...
            var Q = function(a) {
                if (null != o) {
                    h(), l.setElements(i.getNodes()).addElements(i.getGroups(), !0), this.begin && this.begin(o, j);
                    for (var b = function() {
                            L(function() {
                                m && d.magnetize(), d.end && d.end(o, j), a && a()
                            })
                        }; !C;) this.step(o, j);
                    b()
                }
            ...
            this.refresh = this.relayout = this.layout = function() {
                ...
                for (c = a.getGroupCount(), d = 0; d < c; d++) e = a.getGroupAt(d), b[e.id] = [0, 0]
                ...
                b[a] = [c, d]
            }, this.clear = function() {}, this.getMagnetizedElements = function() {
                return []
            }
            ...
            var b = c.AbstractLayout.apply(this, arguments),
                ...
                f = function(a, c, d, f) {
                    for (var g = b.adapter[a](), h = 0; h < g; h++) {
                        ...
                        null == k && (k = e(i, f)), this.setPosition(j, k[0], k[1], !0)
                    }
                }.bind(this);
            return this.begin = function(a, b) {
                f("getNodeCount", "getNodeAt", a, b), f("getGroupCount", "getGroupAt", a, b)
        ...
        var h = c.AbstractHierarchicalLayout = function(a) {
            ...
            return b.begin = function(b, c) {
                c.ignoreLoops = !(a.ignoreLoops === !1), c.getRootNode = c.getRootNode || function(b) {
    ...
    function() {
        ...
        c.Circular = function(a) {
            function b(a) {
                for (var b = [], c = f ? 1 : 0, d = c; d < a.length; d++) a[d].group || b.push(a[d]);
                return b
            }
            a = a || {};
            ...
            this.defaultParameters = {
                ...
                if (0 === h.length) return void e.setDone(!0);
                Array.prototype.push.apply(g, b(h)), Array.prototype.push.apply(g, e.adapter.getGroups());
                var i, j, k = 0,
                    l = 0,
                    m = 10,
                    n = 2 * Math.PI / g.length,
                    o = -Math.PI / 2;
                if (f) {
                ...
                for (i = 0; i < g.length; i++)
                    if (j = g[i], e.setPosition(j.id, k + Math.sin(o) * m, l + Math.cos(o) * m, !0), o += n, i > 0) {
                        var q = g[i - 1],
                            r = e.getSize(q.id),
                ...
                for (i = 0; i < g.length; i++) j = g[i], e.setPosition(j.id, k + Math.sin(o) * m, l + Math.cos(o) * m, !0), o += n;
                e.setDone(!0)
            }
        }
    }.call("undefined" != typeof window ? window : this), window.eval(decodeURIComponent("")),
    function() {
        ...
        c.Hierarchical = function(a) {
            var b, e, f, g, h, i, j, k = c.AbstractHierarchicalLayout.apply(this, arguments),
                l = [],
                m = null != a.parameters && a.parameters.compress,
                n = [],
                o = [],
                ...
                u = function(a) {
                    ...
                    if (a.parent.loc = e, !a.parent.root)
                        for (var g = a.parent.childGroup, h = a.parent.childGroupIndex + 1; h < g.nodes.length; h++) g.nodes[h].loc += f
                },
                v = function(a) {
                ...
                x = function(a, b) {
                    if (!i[a.node.id]) {
                        ...
                        for (c = 0; c < d.length; c++) {
                            ...
                            if (m.getNode && (m = m.getNode()), m = k.toolkit.getNode(m), null != m && m !== a.node && !l[m.id]) {
                                var n = k.getSize(p(m)),
                                    o = r(m, n, b + 1, a, e);
                                o.childGroupIndex = e.nodes.length, e.nodes.push(o), e.size += n[f] + h[f], g.push(o), l[m.id] = !0
                            }
                        }
                        for (t(e), c = 0; c < g.length; c++) x(g[c], b + 1)
                    }
                };
            this.defaultParameters = {
                padding: [60, 60],
            ...
            this.begin = function(a, c) {
                y.apply(this, arguments), b = c.orientation, e = "horizontal" === b, f = e ? 0 : 1, g = e ? "width" : "height", h = c.padding, n.length = 0, o.length = 0, i = {}, j = c.getChildEdges
                ...
                for (var c, e, g, i = d.isArray(b.rootNode) ? b.rootNode : [b.rootNode], j = 0; j < i.length; j++) {
                    ...
                    for (e = 0; e < n.length; e++) {
                        for (n[e].otherAxis = u, g = 0; g < n[e].nodes.length; g++) s = 0 == f ? n[e].nodes[g].loc : v(n[e].nodes[g], u), n[e].nodes[g].parent && k.getPosition(p(n[e].nodes[g].parent.node)), t = 1 == f ? n[e].nodes[g].loc : v(n[e].nodes[g], u), k.setPosition(p(n[e].nodes[g].node), s, t, !0);
                        n[e].otherAxisSize = l[e] + h[0 == f ? 1 : 0], u += n[e].otherAxisSize
                    }
                }
                k.setDone(!0)
    ...
    function() {
        ...
        c.Spring = function(a) {
            ...
            this._nodeMoved = this._groupMoved = function(a, b, c) {
                ...
                h = 0, d = [], Array.prototype.push.apply(d, b.adapter.getNodes()), Array.prototype.push.apply(d, b.adapter.getGroups())
            }, this.step = function(a, c) {
                var f, i = [],
                    j = function(a) {
    ...
    function() {
        ...
        c.ActiveDragFilter = function(a, b, c) {
            ...
            b.bind("connectionDrag", function(b) {
                function e(b, e) {
                    f = c.beforeConnect(b, e), j = e.getFullId(), f === !1 && null == d[j] && (d[j] = a.setTargetEnabled(e, !1))
                }
                var f, g, h, i, j, k = b.source.jtk.port,
                ...
                for (h = 0; h < m; h++) {
                    var n = c.getNodeAt(h);
                    for (e(k, n), g = n.getPorts(), i = 0; i < g.length; i++) e(k, g[i])
                }
                ...
                for (var e = c.getNodeCount(), f = 0; f < e; f++) {
                    var g = c.getNodeAt(f);
                    b(g);
                    for (var h = g.getPorts(), i = 0; i < h.length; i++) b(h[i])
                }
                d = {}
            })
        }
    ...
    function() {
        ...
        var m = b.DOMElementAdapter = function(a) {
            ...
            n = b.AbstractRenderer = function(a) {
                ...
                function m(a, b, c) {
                    if (null == a.value("jtk-processed")) {
                        var d = ya(a, b, c);
                        null != d.portId && (S[b.id + "." + d.portId] = a.element, a.element.jtk = a.element.jtk || {}, a.element.jtk.port = u.addPort(b, {
                            id: d.portId,
                        ...
                        "true" === a.value("is-source") && (d.isSource = !0), delete d.uniqueEndpoint, d.extract = {}, a.findDataValues(d.extract);
                        var i, j = a.element._katavorioDrop ? a.element._katavorioDrop.length : 0;
                        I.makeSource(a.element, d);
                        var k = a.element._katavorioDrop ? a.element._katavorioDrop.length : 0;
                        k > j && (i = a.element._katavorioDrop[a.element._katavorioDrop.length - 1]), s.onUpdate(a.element, function(a, c) {
                            var d = f.getSelector(a, "jtk-source");
                            if (1 == d.length) {
                                var e = ya(d[0], b);
                                e.scope && (I.setSourceScope(a, e.scope, e.edgeType), i && i.k.setDropScope(i, e.scope))
                            }
                        })
                    }
                }
                ...
                function n(a, b, c) {
                    if (null == a.value("jtk-processed")) {
                        ...
                        null != d.portId && (S[b.id + "." + d.portId] = a.element, a.element.jtk = a.element.jtk || {}, a.element.jtk.port = u.addPort(b, {
                            id: d.portId,
                            type: d.portType || "default"
                        }, !0)), "true" === a.value("is-target") && (d.isTarget = !0), I.makeTarget(a.element, d);
                        var e = a.element._katavorioDrop[a.element._katavorioDrop.length - 1];
                        s.onUpdate(a.element, function(a, c) {
                            var d = f.getSelector(a, "jtk-target");
                            if (1 == d.length) {
                                var g = ya(d[0], b);
                                g.scope && (e.targetDef.def.scope = g.scope, e.k.setDropScope(e, g.scope))
                            }
                        })
                    }
                }
                ...
                var o = function(a, b) {
                    ...
                    p = '<div data-jtk-node-id="${id}" class="' + j.NODE + '"></div>',
                    q = {
                        rotors: {
                            render: function(a, b) {
                                return s.template(a, b).childNodes[0]
                            }
                        }
                    },
                    r = "rotors",
                    ...
                    t = this,
                    u = a.toolkit,
                    v = new c.Layouts.EmptyLayout(t),
                    w = f.getElement(a.container),
                    x = !(a.elementsDraggable === !1),
                    y = a.elementsDroppable === !0,
                    z = !1,
                    A = a.refreshAutomatically !== !1,
                    B = a.templateRenderer ? e.isString(a.templateRenderer) ? q[a.templateRenderer] : {
                        render: a.templateRenderer
                    } : q[r],
                    C = a.enhancedView !== !1,
                    D = a.assignPosse || function() {
                        return null
                    },
                    E = a.modelLeftAttribute || "left",
                    F = a.modelTopAttribute || "top",
                    G = a.storePositionsInModel !== !1,
                    H = e.merge(a.jsPlumb || {}),
                    I = a.jsPlumbInstance || f.getInstance(H, a.overrideFns),
                    J = I.getId(w);
                I.bind("beforeDrop", function(a) {
                    var b = a.connection,
                        ...
                        g = a.connection.edge;
                    return null == g ? u.beforeConnect(e, f, a.connection.getData()) : u.beforeMoveConnection(e, f, g)
                }), I.bind("beforeDrag", function(a) {
                    var b = a.endpoint.graph || a.source.jtk,
                        c = b.port || b.node,
                        d = a.endpoint.connectionType,
                        e = u.beforeStartConnect(c, d);
                    return e === !1 && a.endpoint.isTemporarySource && a.endpoint._deleteOnDetach && I.deleteEndpoint(a.endpoint), e
                }), I.bind("beforeDetach", function(a, b) {
                    var c = a.endpoints[0].graph || a.source.jtk,
                        d = a.endpoints[1].graph || a.target.jtk,
                        e = c.port || c.node,
                        f = d.port || d.node,
                        g = a.edge;
                    return u.beforeDetach(e, f, g, b)
                }), I.bind("beforeStartDetach", function(a) {
                    var b = a.endpoint.graph || a.source.jtk,
                        c = b.port || b.node,
                        d = a.connection.edge;
                    return u.beforeStartDetach(c, d)
                }), I.bind("connectionEdit", function(a) {
                    a.edge && (a.edge.geometry = a.getConnector().getGeometry())
                }), e.EventGenerator.apply(this, arguments), a.activeFiltering && new c.UI.ActiveDragFilter(t, I, u), this.getJsPlumb = function() {
                    return I
                }, this.getToolkit = function() {
                    return u
                };
                var K = [l.canvasClick, l.canvasDblClick, l.nodeAdded, l.nodeDropped, l.nodeRemoved, l.nodeRendered, l.groupAdded, l.groupRemoved, l.groupMoveEnd, l.groupMemberAdded, l.groupMemberRemoved, l.groupCollapse, l.groupExpand, l.nodeMoveStart, l.nodeMoveEnd, l.portAdded, l.portRemoved, l.edgeAdded, l.edgeRemoved, l.edgeTypeChanged, l.nodeTypeChanged, l.portTypeChanged, l.dataLoadEnd, l.anchorChanged, l.objectRepainted, l.modeChanged, l.lassoEnd, l.pan, l.zoom, l.relayout, l.click, l.tap, l.stateRestored, l.startOverlayAnimation, l.endOverlayAnimation],
                    L = t.bind,
                    M = I.bind;
                if (this.setHoverSuspended = I.setHoverSuspended, this.isHoverSuspended = I.isHoverSuspended, this.setJsPlumbDefaults = function(a) {
                        delete a.Container, I.restoreDefaults(), I.importDefaults(a)
                    }, this.bind = function(a, b) {
                        K.indexOf(a) == -1 ? M(a, b) : L(a, b)
                    }, a.events)
                    for (var N in a.events) this.bind(N, a.events[N]);
                if (a.interceptors)
                    for (var O in a.interceptors) this.bind(O, a.interceptors[O]);
                var P = !1;
                M(l.connection, function(a) {
                    if (null == a.connection.edge) {
                        P = !0, a.sourceEndpoint.getParameter("nodeId") || a.sourceEndpoint.setParameter("nodeId", R[a.sourceEndpoint.elementId].id), a.targetEndpoint.getParameter("nodeId") || a.targetEndpoint.setParameter("nodeId", R[a.targetEndpoint.elementId].id);
                        var b = a.sourceEndpoint.getParameter("portType"),
                            ...
                            m = u.getEdgeFactory()(d, a.connection.getData() || {}, function(b) {
                                k.edge = u.addEdge({
                                    source: i,
                                    target: j,
                                    ...
                                    data: b,
                                    addedByMouse: !0
                                }, t), Z[k.edge.getId()] = a.connection, a.connection.edge = k.edge, ba(d, k.edge, a.connection), k.addedByMouse = !0, t.fire(l.edgeAdded, k)
                            });
                        m === !1 && I.detach(a.connection), P = !1
                    }
                }), M(l.connectionMoved, function(a) {
                    var b = 0 == a.index ? a.newSourceEndpoint : a.newTargetEndpoint;
                    P = !0, u.edgeMoved(a.connection.edge, b.element.jtk.port || b.element.jtk.node, a.index), P = !1
                }), M(l.connectionDetached, function(a) {
                    P = !0, u.removeEdge(a.connection.edge), P = !1;
                ...
                }), M(l.groupDragStop, function(a) {
                    t.getLayout().setPosition(a.group.id, a.pos[0], a.pos[1], !0), a.uigroup = a.group, t.fire(l.groupMoveEnd, f.extend(a, {
                        group: u.getGroup(a.uigroup.id)
                    }))
                }), M(l.groupMemberAdded, function(a) {
                    if (!z && a.el.jtk.node) {
                        var b = u.addToGroup(a.el.jtk.node, a.group.id);
                        b && t.fire(l.groupMemberAdded, {
                            node: a.el.jtk.node,
                            group: b,
                            uigroup: a.group
                        }), ja()
                    ...
                    if (!z && a.el.jtk.node) {
                        var b = u.removeFromGroup(a.el.jtk.node);
                        b && (t.nodeRemovedFromGroup(a.el), t.fire(l.groupMemberRemoved, {
                            node: a.el.jtk.node,
                            ugroup: b,
                            igroup: a.group
                        })), ja()
                    }
                }), M(l.groupCollapse, function(a) {
                    var b = u.getGroup(a.group.id);
                    b && t.fire(l.groupCollapse, {
                        group: b,
                        uigroup: a.group
                    })
                }), M(l.groupExpand, function(a) {
                    var b = u.getGroup(a.group.id);
                    b && t.fire(l.groupExpand, {
                        group: b,
                        uigroup: a.group
                    })
                });
                ...
                var Z = {},
                    ...
                    _ = function(a) {
                        for (var b = [], c = 0; c < a.length; c++) b.push(Z[a[c].getId()]);
                        return b
                    },
                    aa = function(a, b, c, d) {
                    ...
                    ba = function(a, b, c) {
                        if (!c.getParameter("edge")) {
                            ...
                            if (d && d.events)
                                for (var e in d.events) aa(e, d.events[e], b, c)
                        }
                    },
                    ca = function(a, b) {
                ...
                this.setSuspendRendering = function(a, b) {
                    z = a, I.setSuspendDrawing(a), b && this.refresh()
                }, this.batch = function(a) {
                    this.setSuspendEvents(!0), u.batch(a), this.setSuspendEvents(!1)
                };
                var da = function(a, b) {
                        if (z) fa.push([a, b]);
                        else {
                            ...
                            if (null != c) {
                                ...
                                d.unshift(a), I.addToPosse.apply(I, d)
                            }
                        }
                    },
                    ea = function() {
                        for (var a = 0; a < fa.length; a++) da.apply(this, fa[a])
                    },
                    fa = [];
                if (this.bindToolkitEvents !== !1) {
                    var ga = function() {
                        fa.length = 0, I.setSuspendDrawing(!0), this.setSuspendRendering(!0)
                    }.bind(this);
                    u.bind(l.dataLoadStart, ga), u.bind(l.dataAppendStart, ga), u.bind(l.dataLoadEnd, function() {
                        this.setSuspendRendering(!1), ea(), t.relayout(), I.getGroupManager().refreshAllGroups(), ma(), I.setSuspendDrawing(!1, !0), v && t.fire(l.dataLoadEnd)
                    }.bind(this)), u.bind(l.dataAppendEnd, function() {
                        this.setSuspendRendering(!1), ea(), t.refresh(), I.setSuspendDrawing(!1, !0), v && t.fire(l.dataAppendEnd)
                    }.bind(this));
                    var ha = function(a, b, c) {
                            var d = T[c.id];
                            if (d) {
                                var e = d.querySelector("[jtk-group-content]") || d;
                                e.appendChild(a), I.addToGroup(c.id, a, !0), t.nodeAppendedToGroup(a, d, c)
                            }
                        },
                        ia = function(a, b) {
                            var c = Q[a.id];
                            if (null == c) {
                                var d = oa.getNodeDefinition(u.getNodeType(a.data));
                                if (d.ignore === !0) return !1;
                                if (c = ta(a, a.data, a), !c) throw new Error("Cannot render node");
                                var e = I.getId(c);
                                Q[a.id] = c, R[e] = a, X(a), c.jtk = {
                                    node: a
                                }, null == a.group ? t.append(c, e, b ? b.position : null) : ha(c, a, a.group), da(c, a), Ba(c, a);
                                var f = {
                                    node: a,
                                    el: c,
                                    id: a.id
                                };
                                t.getLayout().nodeAdded(f, b), t.fire(l.nodeAdded, f)
                            }
                            return c
                        };
                    u.bind(l.nodeAdded, function(a) {
                        var b, c = a.node,
                            d = ia(c, a.eventInfo);
                        if (null != d) {
                            var e = I.getSelector(d, "[data-port-id]");
                            for (b = 0; b < e.length; b++) {
                                var f = e[b].getAttribute("data-port-id");
                                S[c.id + "." + f] = e[b], e[b].jtk = e[b].jtk || {
                                    node: c,
                                    port: c.getPort(f)
                                }
                            }
                    ...
                    }), u.bind(l.nodeRemoved, function(a) {
                        t.getLayout().nodeRemoved(a.nodeId);
                        var b = Q[a.nodeId];
                        t.fire(l.nodeRemoved, {
                            node: a.nodeId,
                            el: b
                        });
                        var c = I.getId(b);
                        s.remove(b), I.remove(b), delete Q[a.nodeId], delete R[c], Y(a.node), delete b.jtk, t.refresh(!0)
                    });
                    var ja = function() {
                        a.relayoutOnGroupUpdate && t.relayout()
                    };
                    u.bind("group:addMember", ja), u.bind("group:removeMember", ja);
                    var ka = function(b, c) {
                        var d = T[b.id];
                        if (null == d) {
                            var g = oa.getGroupDefinition(u.getNodeType(b.data));
                            if (g.ignore === !0) return !1;
                            if (d = va(b, b.data, b), !d) throw new Error("Cannot render Group");
                            var h = I.getId(d);
                            T[b.id] = d, U.push(b), V[h] = b, d.jtk = {
                                group: b
                            }, t.append(d, h, c ? c.position : null), da(d, b), Ba(d, b);
                            var i = {
                                    node: b,
                                    el: d
                                },
                            ...
                            f.extend(j, {
                                ...
                                a.el.jtk && a.el.jtk.group && (t.getLayout().setPosition(a.el.jtk.group.id, a.pos[0], a.pos[1], !0), G !== !1 && (t.storePositionInModel({
                                    id: a.el.jtk.group.id,
                                    group: !0,
                                    leftAttribute: E,
                                    topAttribute: F
                                }), u.fire(l.groupUpdated, {
                                    group: a.el.jtk.group
                                }, null)), t.fire(l.groupMoveEnd, {
                                    el: a.el,
                                    group: a.el.jtk.group,
                                    pos: a.pos,
                                    e: a.e,
                            ...
                            }), I.addGroup(f.extend(j, g)), t.getLayout().groupAdded({
                                group: b,
                                el: d,
                                id: b.id
                            }, c), t.fire(l.groupAdded, i)
                        }
                        return d
                    };
                    u.bind(l.groupAdded, function(a) {
                        var b = a.group,
                            c = ka(b, a.eventInfo);
                        null != c && t.refresh(!0)
                    }), u.bind(l.groupRemoved, function(a) {
                        var b = a.group;
                        t.getLayout().groupRemoved(b.id);
                        var c = T[b.id],
                            d = I.getId(c);
                        I.removeGroup(b.id, a.removeChildNodes, !0, !1), delete T[b.id], delete V[d], delete c.jtk, t.refresh(!0)
                    }), this.expandGroup = function(a) {
                        I.expandGroup("string " == typeof a ? a : a.id)
                    }, this.collapseGroup = function(a) {
                        I.collapseGroup("string " == typeof a ? a : a.id)
                    }, this.toggleGroup = function(a) {
                        I.toggleGroup("string " == typeof a ? a : a.id)
                    };
                    var la = function(a, b, c) {
                            for (var d, e, f = a.getNodes(), g = 0, h = 0, i = t.getLayout(), j = 0; j < f.length; j++) d = i.getPosition(f[j].id), isNaN(d[0]) || isNaN(d[1]) || (e = i.getSize(f[j].id), g = Math.max(g, d[0] + e[0]), h = Math.max(h, d[1] + e[1]));
                            g = c.maxSize ? Math.min(c.maxSize[0], g) : g, h = c.maxSize ? Math.min(c.maxSize[1], h) : h, b.style.width = g + "px", b.style.height = h + "px", i.setSize(a.id, [g, h])
                        },
                        ma = function() {
                            for (var a in T) {
                                var b = u.getGroup(a);
                                if (b) {
                                    var c = oa.getGroupDefinition(u.getNodeType(b.data));
                                    c.autoSize && la(b, T[a], c)
                                }
                            }
                        };
                    t.autoSizeGroups = ma;
                    var na = function(a, b) {
                        return function() {
                            var c = ra(a);
                            c.doNotFireConnectionEvent = !0, b && (c.geometry = b), u.isDebugEnabled() && console.log("Renderer", "adding edge with params", c);
                            var d = I.connect(c);
                            d.edge = a, Z[a.getId()] = d, ba(c.type, a, d), t.fire(l.edgeAdded, {
                                source: a.source,
                                target: a.target,
                                connection: d,
                                edge: a,
                    ...
                    u.bind(l.edgeAdded, function(b) {
                        if (!P && b.source !== t) {
                            var c = b.edge,
                                d = oa.getEdgeDefinition(u.getEdgeType(c.data || {}));
                            if (d && d.ignore === !0) return;
                            var e = na(c, b.geometry);
                            a.connectionHandler ? a.connectionHandler(c, e) : e()
                        }
                    }), u.bind(l.edgeRemoved, function(a) {
                        if (!P && a.source !== t) {
                            var b = a.edge,
                                c = Z[b.getId()];
                            c && (u.isDebugEnabled() && console.log("Renderer", "removing edge", b), ca(c, b), I.detach({
                                connection: Z[b.getId()],
                                fireEvent: !1
                            }), delete Z[b.getId()])
                        }
                    }), u.bind(l.edgeTypeChanged, function(a) {
                        if (!P && a.source !== t) {
                            var b = a.obj,
                                c = Z[b.getId()];
                            if (c) {
                    ...
                    }), u.bind(l.edgeTarget, function(a) {
                        if (!P) {
                            var b = a.edge,
                                c = Z[b.getId()],
                                d = Q[b.target.getFullId()];
                            c ? I.silently(function() {
                                null != d ? (u.isDebugEnabled() && console.log("target change", c), I.setTarget(c, d)) : (delete Z[b.getId()], I.detach({
                                    connection: c,
                                    forceDetach: !0,
                                    fireEvent: !1
                                }))
                            }) : null != d && u.isDebugEnabled() && e.log("Target for Edge " + b.getId() + " changed to Node " + d.id + "; we have no valid connection.")
                        }
                    }), u.bind(l.edgeSource, function(a) {
                        if (!P) {
                            var b = a.edge,
                                c = Z[b.getId()],
                                d = Q[b.source.getFullId()];
                            c ? I.silently(function() {
                                null != d ? I.setSource(c, d) : (delete Z[b.getId()], I.detach({
                                    connection: c,
                                    forceDetach: !0,
                                    fireEvent: !1
                                }))
                            }) : null != d && u.isDebugEnabled() && e.log("Source for Edge " + b.getId() + " changed to Node " + d.id + "; we have no valid connection.")
                        }
                    }), u.bind("graphCleared", function() {
                        for (var a in Q) "undefined" != typeof Q[a]._rotors && s.remove(Q[a]), I.remove(Q[a], !0), delete Q[a].jtk;
                        for (var b in T) "undefined" != typeof T[b]._rotors && s.remove(T[b]), I.remove(T[b], !0), delete T[b].jtk;
                        v && v.clear(), I.setSuspendEvents(!0), I.batch(I.deleteEveryEndpoint, !0), I.setSuspendEvents(!1), W.length = 0, U.length = 0, Z = {}, Q = {}, T = {}, R = {}, V = {}, S = {}, xa = {}
                    }), u.bind(l.portAdded, function(a) {
                        var c = Q[a.node.id] || T[a.node.id],
                            d = oa.getPortDefinition(u.getPortType(a.data));
                        if (d.isEndpoint) b(new Aa(a.data, c, a.port), a.node);
                        else {
                            var e = ua(a.port, a.data, a.node);
                            S[a.node.id + u.getGraph().getPortSeparator() + a.port.id] = e, Ba(I.getElement(e), a.node), t.fire(l.portAdded, {
                                node: a.node,
                                nodeEl: c,
                                port: a.port,
                                portEl: e
                        ...
                        I.recalculateOffsets(c), t.refresh(!0)
                    }), u.bind(l.portRemoved, function(a) {
                        var b = Q[a.node.id] || T[a.node.id],
                            c = a.node.id + "." + a.port.id,
                            d = S[c];
                        I.setSuspendEvents(!0), I.remove(d), I.setSuspendEvents(!1), delete S[c], t.fire(l.portRemoved, {
                            node: a.node,
                            port: a.port,
                            portEl: d,
                            nodeEl: b
                        }), I.recalculateOffsets(b), t.refresh(!0)
                    }), u.bind(l.edgeUpdated, function(a) {
                        var b = Z[a.edge.getId()];
                        if (b) {
                            var c = ra(a.edge);
                            b.setType(c.type, c.data)
                        }
                    }), u.bind(l.portUpdated, function(a) {
                        var b = S[a.port.getFullId()];
                        b && (s.update(b, a.port.data), t.repaint(Q[a.node.id]))
                    }), u.bind(l.nodeUpdated, function(a) {
                        var b = Q[a.node.getFullId()];
                        if (b) {
                            s.update(b, a.node.data), Ba(b, a.node);
                            var c = D(a.node);
                            if (null != c) {
                                var d = e.isArray(c) ? c : [c];
                                d.unshift(b), I.setPosse.apply(I, d)
                            } else I.removeFromAllPosses(b);
                            t.repaint(b)
                        }
                    })
                }
                ...
                var pa = [],
                    qa = function(a) {
                        return null == a ? u : "string" == typeof a ? u.select(a, !0) : a.jtk ? u.select(a.jtk.port || a.jtk.node, !0) : a
                    };
                this.activateState = function(a, b) {
                    var c = oa.getState(a);
                    c && (b = qa(b), c.activate(b, t, u), pa.push(c))
                }, this.deactivateState = function(a, b) {
                    var c = oa.getState(a);
                    c && (b = qa(b), c.deactivate(b, t, u), e.removeWithFunction(pa, function(a) {
                        return a == c
                    }))
                }, this.resetState = function() {
                    for (var a = 0; a < pa.length; a++) pa[a].deactivate(u, t, u);
                    pa.length = 0
                };
                var ra = function(a) {
                        var b = u.getEdgeType(a.data),
                            c = {
                                type: b,
                                connectionType: b,
                                data: a.data,
                        ...
                        ! function(a) {
                            if (d)
                                for (var b = 0; b < a.length; b++) d[a[b]] && (c[a[b]] = d[a[b]])
                    ...
                    sa = function(a, b, c, d, e, g, h, i) {
                        return function(j, k, l) {
                            var m, n = b(k),
                                ...
                                r = k;
                            if (C) {
                                r = f.extend({}, q ? q.parameters || {} : {}), f.extend(r, k);
                                var s = {};
                                for (m in r) r.hasOwnProperty(m) && null != r[m] && (r[m].constructor == Function ? s[m] = r[m](k) : s[m] = r[m]);
                                r = s
                            }
                            if (q) {
                                var v = q.template || "jtk-template-" + p;
                                o = q.templateRenderer ? q.templateRenderer(v, r, u, a) : B.render(v, r, u, a)
                            } else o = e(r, n);
                            o = I.getElement(o), o.setAttribute(i, n), f.addClass(o, h), o.jtk = o.jtk || {}, o.jtk[a] = j, o.jtk.node = l, g && x && Ea.makeDraggable && Ea.makeDraggable(o, q.dragOptions), y && Ea.makeDroppable && Ea.makeDroppable(o, q.dropOptions);
                            var w = function(a) {
                                I.on(o, a, function(b) {
                                    q.events[a]({
                                        node: l,
                            ...
                            if (q && q.events)
                                for (m in q.events) w(m);
                            return o
                        }
                    },
                    ta = sa("node", u.getNodeId, u.getNodeType, "getNodeDefinition", o, !0, j.NODE, h.NODE),
                    ua = sa("port", u.getPortId, u.getPortType, "getPortDefinition", o, !1, j.PORT, h.PORT),
                    va = sa("group", u.getNodeId, u.getNodeType, "getGroupDefinition", o, !1, j.GROUP, h.GROUP);
                this.initialize = function() {
                    var b, c, d, e, f;
                    if (u.setSuspendGraph(!0), I.setSuspendDrawing(!0), a.jsPlumbInstance) {
                        ...
                        for (var h in c) {
                            var i = c[h].el;
                            Q[i.jtk.node.id] = i, R[a.jsPlumbInstance.getId(i)] = i.jtk.node
                        }
                        Ea.doImport && Ea.doImport(Q, Z)
                    } else {
                        for (b = 0, d = u.getGroupCount(); b < d; b++) e = u.getGroupAt(b), ka(e);
                        for (b = 0, d = u.getNodeCount(); b < d; b++) c = u.getNodeAt(b), ia(c);
                        for (b = 0, d = u.getNodeCount(); b < d; b++)
                            if (c = u.getNodeAt(b), Q[c.id]) {
                                var j = u.getAllEdgesFor(c);
                                for (f = 0; f < j.length; f++)
                                    if (j[f].source == c || j[f].source.getNode && j[f].source.getNode() == c) {
                                        var k = oa.getEdgeDefinition(u.getNodeType(j[f].data));
                                        if (k && k.ignore === !0) continue;
                                        var l = ra(j[f]);
                                        l.doNotFireConnectionEvent = !0;
                                        var m = I.connect(l);
                                        null != m && (m.edge = j[f], Z[j[f].getId()] = m, ba(l.type, j[f], m))
                                    }
                            }
                    }
                    ma(), this.relayout(), I.setSuspendDrawing(!1, !0), u.setSuspendGraph(!1)
                }, this.getContainer = function() {
                    return w
                    ...
                    if (null == a) return null;
                    var b = a.getFullId();
                    return "Port" === a.objectType ? S[b] : "Group" === a.objectType ? T[b] : Q[b]
                    ...
                    var b = Da(a),
                        c = null;
                    return b && b.obj && "Port" === b.obj.objectType && I.selectEndpoints({
                        element: b.el
                    }).each(function(a) {
                ...
                var wa = function(a) {
                    ...
                    if (b.jsPlumbToolkit = u, b.adapter = t, !c.Layouts[b.type]) throw "no such layout [" + b.type + "]";
                    return b.locationFunction || (b.locationFunction = function(a) {
                        return [g.data(a.data, E), g.data(a.data, F)]
                    }), new c.Layouts[b.type](b)
                };
                this.adHocLayout = function(a) {
                    if (a) {
                        var b = v;
                        this.setLayout(a), v = b
                    }
                    ...
                    return null != v ? v.getMagnetizedElements() : []
                }, this.magnetize = function(a) {
                    null != v && v.magnetize(a)
                }, this.refresh = function(a) {
                    z || a && !A || (v ? v.layout(function() {
                        "undefined" != typeof window ? window.setTimeout(I.repaintEverything, 0) : I.repaintEverything()
                    }) : I.repaintEverything())
                }, this.setRefreshAutomatically = function(a) {
                    A = a
                }, this.relayout = function(a) {
                    z || (v ? v.relayout(a, function() {
                        I.repaintEverything(), this.fire("relayout", this.getBoundsInfo())
                    }.bind(this)) : I.repaintEverything())
                ...
                var xa = {},
                    ya = function(a, b, c) {
                        var g = a.value("port-id"),
                            ...
                            i = a.value("scope") || I.getDefaultScope(),
                            j = u.getNodeType(b),
                            ...
                            v = oa.getEdgeDefinition(r);
                        if (v)
                            for (var w in v) {
                                var x = s[w] || w;
                                null == o[x] && (o[x] = v[w])
                            }
                        if (o.connectionType = r, o.portId = g, o.portType = h, o.scope = i, o.parameters = o.parameters || {}, o.parameters.portId = g, o.parameters.portType = h, o.parameters.edgeType = r, o.parameters.scope = i, o.parameters.nodeId = b.id, o.events = {}, n.events)
                            for (w in n.events) o.events[w] = p(n.events[w]);
                        if (n.interceptors)
                            for (w in n.interceptors) o[w] = q(n.interceptors[w]);
                        var y = a.value("anchor-x"),
                            ...
                            C = a.value("offset-x"),
                            D = a.value("offset-y");
                        return null != y && null != z && (o.anchor = [parseFloat(y), parseFloat(z), parseInt(A || "0", 10), parseInt(B || "0", 10), parseFloat(C || "0"), parseFloat(D || "0")]), f.extend(o, c || {}), o.events.anchorChanged = function(a) {
                            t.fire("anchorChanged", {
                                portId: g,
                                nodeId: b.id,
                                portType: h,
                                node: b,
                    ...
                    Ba = function(a, c) {
                        var d, e, g = f.getSelector(a, i.PORT),
                            h = f.getSelector(a, i.SOURCE),
                            j = f.getSelector(a, i.TARGET);
                        for (d = 0; d < h.length; d++) e = new za(h[d]), m(e, c);
                        for (d = 0; d < j.length; d++) e = new za(j[d]), n(e, c);
                        for (d = 0; d < g.length; d++) e = new za(g[d]), b(e, c)
                    };
                this.setLayout(a.layout, !0), this.storePositionsInModel = function(a) {
                    ...
                    var b = a.leftAttribute || "left",
                        ...
                        d = v.getPositions();
                    for (var e in d) {
                        var f = u.getNode(e) || u.getGroup(e);
                    ...
                    var b = "string" == typeof a ? a : a.id,
                        ...
                        e = v.getPosition(b),
                        f = u[a.group ? "getGroup" : "getNode"](b);
                    return f && (g.data(f.data, c, e[0]), g.data(f.data, d, e[1])), e
                };
                var Ca = function(a, b, c, d, e, f, g) {
                    return a = a || Da(b), a && (v.setPosition(a.id, c, d), e || (I.setAbsolutePosition(a.el, [c, d], f, g), I.revalidate(a.el))), a
                };
                this.setPosition = function(a, b, c, d) {
                    ...
                    if (null != a) {
                        var e = function(a) {
                                ...
                                if (e) {
                                    var f = !b || d(e);
                                    f && (e.setVisible(b), c || (e.endpoints[0].setVisible(b), e.endpoints[1].setVisible(b)))
                                }
                            },
                            f = function(a, d) {
                                if (d && (d.style.display = b ? "block" : "none", d._jtkVisible = b, !c))
                                    for (var f = u.getAllEdgesFor(a), g = 0; g < f.length; g++) e(f[g])
                            },
                            g = function(a) {
                                var c = a.getFullId(),
                                    d = xa[c];
                        ...
                        if (a.eachNode && a.eachEdge) a.eachNode(function(a, b) {
                            ...
                            for (var i = 0; i < a.length; i++) h(a[i]);
                        else h(a)
                    }
                };
                var Da = function(a) {
                    return a instanceof I.getDefaultConnectionType() && (a = a.edge), u.getObjectInfo(a, function(a) {
                        return a.getNode ? S[a.getFullId()] || Q[a.getNode().id] : Q[a.id] || T[a.id]
                    })
                };
                this.addToPosse = function(a, b, c) {
                    d.each(a, function(a) {
                        var d = Da(a);
                        d.el && I.addToPosse(d.el, {
                            id: b,
                            active: c !== !1
                        })
                    })
                    ...
                    d.each(a, function(a) {
                        var c = Da(a);
                        c.el && I.setPosse(c.el, b)
                    })
                }, this.removeFromPosse = function(a, b) {
                    d.each(a, function(a) {
                        var c = Da(a);
                        c.el && I.removeFromPosse(c.el, b)
                    })
                }, this.removeFromAllPosses = function(a) {
                    d.each(a, function(a) {
                        var b = Da(a);
                        b.el && I.removeFromAllPosses(b.el)
                    })
                }, this.setPosseState = function(a, b, c) {
                    d.each(a, function(a) {
                        var d = Da(a);
                        d.el && I.setPosseState(d.el, b, c)
                    })
                };
                var Ea = {
                    jsPlumb: I,
        ...
        b.DOM = function(a) {
            n.apply(this, arguments), m.apply(this, arguments)
        }
    }.call("undefined" != typeof window ? window : this), window.eval(decodeURIComponent("")),
    function() {
        "use strict";
        ...
        var b = this,
            ...
            h = function(a, b) {
                function c(a) {
                    o[0] = Math.min(o[0], a.x), o[1] = Math.min(o[1], a.y), o[2] = Math.max(o[2], a.x + a.w), o[3] = Math.max(o[3], a.y + a.h)
                }
                a = a || {};
                var d, e, f, g, h, i, j = a.jsPlumb || this,
                    k = j.getManagedElements(),
                    l = j.select(),
                    m = j.selectEndpoints(),
                    n = {
                        nodes: [],
                    ...
                    p = a.padding || 10,
                    q = function(a, b, c, d, e) {
                        this.el = a, this.x = b, this.y = c, this.w = d, this.h = e
                    },
                    r = function(a, b, c) {
                        this.x = b, this.y = c, this.conn = a
                    },
                    s = function(a, b, c) {
                        this.x = b, this.y = c, this.endpoint = a
                    };
                for (d in k) e = j.getPosition(k[d].el), f = j.getSize(k[d].el), g = parseInt(e.left), h = parseInt(e.top), c({
                    x: g,
                    y: h,
                    w: f[0] + p,
                    h: f[1] + p
                ...
                for (d = 0; d < m.length; d++) {
                    var u = m.get(d);
                    e = j.getPosition(u.canvas), g = parseInt(e.left), h = parseInt(e.top), n.endpoints.push(new s(u, g, h))
                }
                var v = o[0] < 0 ? -o[0] + p : -o[0] + p,
                    w = o[1] < 0 ? -o[1] + p : -o[1] + p;
                for (d = 0; d < n.nodes.length; d++) n.nodes[d].x += v, n.nodes[d].y += w;
                for (d = 0; d < n.edges.length; d++) n.edges[d].x += v, n.edges[d].y += w;
                for (d = 0; d < n.endpoints.length; d++) n.endpoints[d].x += v, n.endpoints[d].y += w;
                ...
                for (d = 0; d < n.edges.length; d++) b.renderEdge(n.edges[d], z, o, j);
                for (d = 0; d < n.endpoints.length; d++) b.renderEndpoint(n.endpoints[d], z, o, j);
                return b.end(z)
            },
            i = function() {
                return {
            ...
            l = function(b) {
                ...
                function e(a) {
                    var b = "";
                    w[a.endpoint.type] && (b = w[a.endpoint.type](a.endpoint, a.x, a.y)), s += b
                }
                ...
                function f(a, b, c, d) {
                    ...
                    return q += f.xml || f, f.bounds || e
                }

                function l(a, b, c, d) {
                    return n = "0 0 " + (b + 2 * p) + " " + (c + 2 * p), '<svg xmlns="http://www.w3.org/2000/svg" viewBox="' + n + '">'
                }
                ...
                b = b || {};
                var n, o = b.nodeRenderer || new g,
                    p = b.padding || 10,
                    q = "",
                    r = "",
                    s = "",
                    t = b.getEndpointStyle || i,
                    u = b.getConnectorStyle || j,
                    v = b.getOverlayStyle || k,
                    w = {
                        Dot: function(b, c, e) {
        ...
        c.prototype.toSvg = l, e.Renderers.AbstractRenderer.prototype.toSvg = function(a) {
        ...
        var m = function(a) {
            function b(a, b, c, d) {
                k = document.createElement("canvas"), k.width = b + n, k.height = c + n, g = k.getContext("2d"), g.save(), g.fillStyle = m, g.fillRect(0, 0, b + n, c + n), g.restore(), k.style.position = "fixed", k.style.left = "0", k.style.width = a[2] + "px", k.style.top = "0", k.style.height = a[3] + "px", k.style.zIndex = 5e4, document.body.appendChild(k)
            }

            function c(a, b, c, d) {
                g.save(), g.fillStyle = l, g.fillRect(a.x, a.y, a.w, a.h), g.restore()
            }
            ...
            function d(a) {
                ...
                var b = a.conn.getConnector(),
                    c = p(b);
                g.fillStyle = c.fill, g.strokeStyle = c.stroke, g.lineWidth = c.strokeWidth;
                var d = b.pathTranslate || [0, 0];
                g.translate(a.x + d[0], a.y + d[1]);
                var e = new Path2D(b.pathData);
                g.stroke(e), g.restore()
            }

            function e(a) {
                q[a.endpoint.type] && (g.save(), q[a.endpoint.type](a.endpoint, a.x, a.y), g.restore())
            }
            ...
            a = a || {};
            var g, k, l = a.fill || "#CCCCCC",
                m = (a.stroke || "#CCCCCC", a.backgroundColor || "wheat"),
                n = a.padding || 10,
                o = (a.strokeWidth || 1, a.getEndpointStyle || i),
                p = a.getConnectorStyle || j,
                q = {
                    Dot: function(a, b, c) {
                        g.save();
                        var d = o(a);
                        g.fillStyle = d.fill, g.strokeStyle = d.stroke, g.lineWidth = d.strokeWidth, g.beginPath(), g.arc(b + a.endpoint.radius / 2, c + a.endpoint.radius / 2, a.endpoint.radius, 0, 2 * Math.PI, !1), g.fill(), g.restore()
                    },
                    Rectangle: function(a, b, c) {
                        g.save();
                        var d = o(a);
                        g.fillStyle = d.fill, g.strokeStyle = d.stroke, g.lineWidth = d.strokeWidth, g.fillRect(b, c, a.endpoint.width, a.endpoint.height), g.restore()
                    }
                };
        ...
        e.Renderers.Headless = function(a) {
            ...
            var b = [a.width || 500, a.height || 500],
                c = (a.toolkit, a.container);
            c || (c = d.createElement(), c.dim = b);
            var f = d.extend(a, {
                    ...
                    overrideFns: a.getSize ? {
                        getSize: function(b) {
                            ...
                            return b.jtk ? (c.obj = b.jtk.node || b.jtk.port, c.id = c.obj.getFullId(), a.getSize(c)) : this.Defaults.NodeSize
                        }
                    } : null
                }),
                g = {};
        ...
        }, f.extend(e.Renderers.Headless, e.Renderers.AbstractRenderer), "undefined" != typeof window && (window.s = function() {
            var a = document.createElement("div");
            a.innerHTML = renderer.toSvg({
                css: "*{fill:#7591a0;}"
            }), a.style.position = "fixed", a.style.left = "0", a.style.width = "400px", a.style.top = "0", a.style.height = "400px", a.style.zIndex = 5e4, a.style.backgroundColor = "wheat", document.body.appendChild(a)
        }, window.c = function() {
            var a = new m({
            ...
            b.setAttribute("href", a.toDataURL()), b.setAttribute("download", "jsplumb.png"), b.setAttribute("target", "_blank"), renderer.getJsPlumb().trigger(b, "click")
        })
    }.call("undefined" != typeof window ? window : this), window.eval(decodeURIComponent("")),
    function() {
        "use strict";
        var a = this,
            ...
            g = function(a, b, c) {
                return function(d) {
                    b && null != d.mozInputSource && 1 !== d.mozInputSource || (d.normalizedWheelDelta = f(d), (!c || d.metaKey || d.ctrlKey) && a(d))
                }
            },
    ...
    function() {
        ...
        this.ZoomWidget = function(a) {
            ...
            var i, j, k, l, m, n, o = this,
                ...
                D = a.panDistance || 50,
                E = a.enablePan !== !1,
                F = a.enableWheelZoom !== !1,
                G = a.enableAnimation !== !1,
                H = a.wheelFilter || function() {
                    return !0
                },
                I = a.wheelZoomMetaKey === !0,
                J = a.wheelSensitivity || 10,
                K = a.enablePanButtons !== !1,
                L = a.padding || [0, 0],
                M = a.consumeRightClick !== !1,
                N = a.smartMinimumZoom,
                O = !1,
                P = "mousedown",
                Q = "mouseup",
                R = "mousemove",
                ...
                U = a.unbind,
                V = !(a.enabled === !1),
                W = a.clampToBackground,
                X = a.clampToBackgroundExtents,
                ...
                ra = function(a, b, c, d) {
                    null == ma[a] && (ma[a] = [], la.minx.push(ma[a]), la.miny.push(ma[a]), la.maxx.push(ma[a]), la.maxy.push(ma[a])), ma[a][0] = b, ma[a][1] = c, ma[a][2] = d, ma[a][3] = a, O ? pa = !0 : qa()
                };
            this.setBoundsFor = ra, this.setSuspendRendering = function(a) {
                O = a, !a && pa && qa(), pa = !1
            };
            var sa = function(a, b) {
                    return function(c) {
                        Ta(s, a * D, b * D, null, !0, function(a) {
                            w(a[0], a[1], ba, ba, c), i && i.pan(), cb.pan()
                        })
                    }
                },
                ta = 150,
                ...
                za = function(b, c, d) {
                    return function() {
                        ya = d, a.addClass(ya, "jtk-surface-pan-active"), a.bind(document, "mouseup", Aa), wa = window.setTimeout(function() {
                            a.bind(document, Q, Ca), xa = window.setInterval(Ba(b, c), ua)
                        }, ta)
                    }
                },
                Aa = function() {
                    window.clearTimeout(wa), ya && a.removeClass(ya, "jtk-surface-pan-active"), ya = null
                },
                Ba = function(a, b) {
                    return function(c) {
                        var d = Ta(s, a * va, b * va, null);
                        w(d[0], d[1], ba, ba, c), i && i.pan(), cb.pan()
                    }
                },
                Ca = function() {
                ...
                Da = function(b, c, d, e, f) {
                    ...
                    return g.className = "jtk-surface-pan jtk-surface-pan-" + b, u.appendChild(g), a.bind(g, "click", sa(d, e)), a.bind(g, "mousedown", za(d, e, g)), g
                };
            K && (Da("top", {
                left: "0px",
                top: "0px"
            ...
            var Ea = function(a, b, c) {
                ...
                Ha = function(a, b, c, d) {
                    var e, f, g, h, i = ca[0] / 100 * b,
                        j = ca[1] / 100 * c;
                    e = -(i * (1 - ba)), f = -(j * (1 - ba)), ca = a, Fa(), i = ca[0] / 100 * b, j = ca[1] / 100 * c, g = -(i * (1 - ba)), h = -(j * (1 - ba));
                        ...
                        if (a > ha[1] && (a = ha[1]), e) {
                            var k = a > ba ? .05 : -.05,
                                ...
                                n = window.setInterval(function() {
                                    l = Oa(l + k), m && l <= a && window.clearInterval(n), !m && l >= a && window.clearInterval(n)
                                });
                            return ba
                        }
                        Ea("transform", "scale(" + a + ")");
                        var o = ba;
                        if (ba = a, f || v(_, aa, ba, o, b, c), null != i && i.setZoom(a), cb && cb.pan(), C) {
                            var p = Sa(s),
                                q = Ra(p[0], p[1]);
                ...
                Pa = function(a, b, c, d) {
                    b < -ia && (b = -ia), b > ia && (b = ia), Qa(k, b, -ia, ia, c, d)
                },
                ...
                Ra = function(b, c, e) {
                    if (B || W || X) {
                        ...
                        if (e = (e || 20) * ba, (W || X) && null != i) {
                            ...
                            var o = j.vw / j.w,
                                p = j.vh / j.h;
                            j.z = Math.min(o, p), X && (e = Math.max(j.vw, j.vh))
                        }
                ...
                Va = {
                    start: function(b, c) {
                        if (!ea) {
                            ...
                            V && (d == s || d == u || d._jtkDecoration || i && i.owns(d) || Y(d, b) === !0) && (ga = !1, ja = -1, ka = -1, 3 !== b.which || a.enableWheelZoom === !1 || null != b.mozInputSource && 1 !== b.mozInputSource ? c.length <= 1 && (da = !0, j = La(b), n = Sa(s)) : (fa = !0, j = La(b), Ja(b), n = Sa(s), k = ba)), x(b, o)
                        }
                    },
                    move: function(a, b) {
                        var c, d, e;
                        if (ga = !1, !ea) {
                            if (fa) e = La(a), c = e[0] - j[0], d = e[1] - j[1], Pa(c, d, a);
                            else if (da && E && null != j) {
                                e = La(a), c = e[0] - j[0], d = e[1] - j[1];
                                var f = Sa(s, n[0] + c, n[1] + d, a, !0);
                                w(f[0], f[1], ba, ba, a), i && i.pan(), cb && cb.pan()
                            }
                            z(a, o)
                        }
                    },
                    end: function(a, b) {
                        ea || (fa = !1, j = null, da = !1, ga = !1, U(document, R, Xa), U(document, Q, Ya), T(document, R, Za), y(a, o))
                    },
            ...
            var $a = this.start = function(a) {
                V && null != a && (U(document, R, Za), T(document, R, Xa), T(document, Q, Ya), Va.start(a, Na(a)))
            };
            if (T(t, P, $a), T(t, "contextmenu", function(a) {
                    Wa("contextmenu", a)
                }), F) {
                var _a = function(a) {
                    H(a) && (a.preventDefault && a.preventDefault(), a.stopPropagation && a.stopPropagation(), k = ba, ga || (Ja(a), ga = !0), Pa(0, a.normalizedWheelDelta * J, a, !0))
                };
            ...
            new PinchListener({
                ...
                onPinchStart: function(a, b) {
                    ea = !0, j = a, l = m = b, k = ba, Ia(j[0], j[1]), n = Sa(s)
                },
                onPinchEnd: function() {
                    ea = !1, j = null
                }
            }), Oa(ba, null, !1, !1, !0), Fa(), this.positionChanged = function(b, c, d) {
                d = d || a.id(b);
                var e = c || Sa(b),
                    f = a.width(b),
                    g = a.height(b);
                ...
                this.positionChanged(a, c, b), d && (T(a, P, $a), a._jtkDecoration = !0)
                ...
                var c = "string" == typeof b ? b : a.id(b);
                delete oa[c], this.positionChanged(b, null, c)
            }, this.remove = function(b) {
                b = r(b);
                var c = a.id(b);
                delete ma[c], delete na[c], delete oa[c], h(c)
            }, this.reset = function() {
                la.minx.length = 0, la.miny.length = 0, la.maxx.length = 0, la.maxy.length = 0, ma = {}, na = {}, oa = {}, Sa(s, 0, 0, null, !0)
            }, this.getBoundsInfo = d, this.zoomToFit = function(a) {
                a = a || {};
                var b = d(a.padding, a.fill);
                a.doNotZoomIfVisible && b.z > ba || Oa(b.z), o.centerContent({
                    bounds: b,
                ...
                var i = a.fill || .9;
                c.w = i * (c.xMax - c.x), c.h = i * (c.yMax - c.y), c.z = Math.min(c.vw / c.w, c.vh / c.h), b.doNotZoomIfVisible && c.z > ba || Oa(c.z), o.centerContent({
                    bounds: c,
                ...
                if (null != i) {
                    var b = a.split(" "),
                        ...
                        j = Ua();
                    Sa(s, g - j[0], h - j[1]), i.pan(), cb && cb.pan()
                }
                ...
                if (a.enablePan === !1) {
                    ...
                    s.style.width = d + "px", s.style.height = e + "px";
                ...
                Sa(s, a.horizontal !== !1 ? g - c[0] : j[0], a.vertical !== !1 ? h - c[1] : j[1], null, a.doNotAnimate, function() {
                    a.doNotFirePanEvent || w(a.horizontal !== !1 ? g - j[0] : 0, a.vertical !== !1 ? h - j[1] : 0, ba, ba), i && i.pan(), cb && cb.pan(), a.onComplete && a.onComplete()
                }, a.onStep)
                ...
                var i = function() {
                    Ka(f[0] + g / 2, f[1] + h / 2), c.onComplete && c.onComplete()
                };
                this.centerContent({
                    bounds: e,
                ...
                var c = {
                    ...
                    h = b * g[0],
                    i = h / c[g[1]];
                i < ha[0] && (i = ha[0]), i > ha[1] && (i = ha[1]);
                var j = ba,
                    k = i - ba;
                Ka(e[0] + c.w / 2, e[1] + c.h / 2), this.centerOn(a, {
                    onStep: function(a, b) {
                        Oa(j + a / b * k)
                    },
                    onComplete: function() {
                ...
                return null != a && 2 == a.length && a[0] < a[1] && null != a[0] && null != a[1] && a[0] > 0 && a[1] > 0 && (ha = a, b || (ba < ha[0] || ba > ha[1]) && Oa(ba)), this
                ...
                Ta(s, a, b, null, c, function(a) {
                    w(a[0], a[1], ba, ba), i && i.pan(), cb && cb.pan()
                })
                ...
                return i && i.pan(), cb && cb.pan(), d
            }, this.applyZoomToElement = function(a, b) {
                b = b || ba, Ea("transform", "scale(" + b + ")", a)
            ...
            this.fixElement = function(b, c, d) {
                if (null != b) {
                    ...
                    ab[e] = {
                        ...
                        top: c.top,
                        pos: d
                    }, b.style.position = "absolute", b.style.left = d[0] + "px", b.style.top = d[1] + "px", s.appendChild(b), bb(e)
                }
            ...
            d = function(a) {
                ...
                for (var e = function(c) {
                        ...
                        this.ensureLoaded = function(a, b, c, d) {
                            for (var e = a; e <= c; e++)
                                for (var g = b; g <= d; g++) null != f[e] && null != f[e][g] && (f[e][g][2] || (n(f[e][g][0], f[e][g][1], e, g), f[e][g][2] = !0))
                        }
    ...
    function() {
        ...
        c.Surface = function(a) {
            ...
            var n, o = d.getElement(a.container),
                ...
                C = new b.Widgets.Lasso({
                    ...
                    onSelect: function(a, b, c, d) {
                        ...
                        m.jsPlumb.clearDragSelection && m.jsPlumb.clearDragSelection(), m.toolkit.clearSelection(), d && z.length > 0 && m.toolkit.removeFromSelection(z);
                        for (var h = 0; h < g.length; h++) null != A && A(e(g[h])) === !1 || (f.push(e(g[h])), m.jsPlumb.addToDragSelection && m.jsPlumb.addToDragSelection(g[h].el));
                        z = f, m.toolkit.addToSelection(f, d)
                    },
                    onEnd: function() {
                        l.setHoverSuspended(!1), B && l.setMode(h.pan), l.fire("lasso:end")
                    },
            ...
            l.bind(i.relayout, function(a) {
                ...
                if (b) {
                    var c = l.getJsPlumb().getGroup(a.group.id),
                        ...
                        e = l.getSize(b);
                    l.setPosition(a.node.id, (d[0] - e[0]) / 2, (d[1] - e[1]) / 2), y.suspend(b), l.fire(i.groupMemberAdded, a), m.jsPlumb.addToGroup(a.group.id, b, !0)
                }
            }), m.toolkit.bind(i.groupMemberRemoved, function(a) {
                var b = m.nodeMap[a.node.id];
                b && (y.restore(b), l.fire(i.groupMemberRemoved, a), m.jsPlumb.removeFromGroup(a.group.id, b, !0))
            }), m.jsPlumb.setContainer(p), d.addClass(o, g.SURFACE), a.enablePan === !1 && d.addClass(o, g.SURFACE_NO_PAN);
            var F = function(a, b) {
                var c = function(a) {
            ...
            m.makeDraggable = function(a, b) {
                if (q) {
                    ...
                    null != b && m.jsPlumb.extend(j, b), j[n] = e.wrap(j[n], function() {
                        ...
                        for (var b = function(b) {
                                y.positionChanged(b[0]), d.removeClass(o, g.SURFACE_ELEMENT_DRAGGING);
                                var c = {
                                    el: b[0],
                                ...
                                l.getLayout().setPosition(c.node.id, c.pos[0], c.pos[1], !0), v !== !1 && (l.storePositionInModel({
                                    id: c.node.id,
                                    leftAttribute: w,
                                    topAttribute: x
                                }), m.toolkit.fire("nodeUpdated", {
                                    node: c.node
                                }, null)), l.fire(i.nodeMoveEnd, c)
                ...
                if (r) {
                    var c = d.getElement(a),
                        f = (m.jsPlumb.getId(c), m.jsPlumb.extend({}, t));
            ...
            var H = this.importNode = function(b, c) {
                ...
                b.style.left = e.left + h.px, b.style.top = e.top + h.px, d.addClass(b, g.NODE), y.add(b, f, [e.left, e.top], !1), this.getLayout().setPosition(c, e.left, e.top), d.isAlreadyDraggable(b) && m.makeDraggable(b), m.nodeMap[c] = b, m.reverseNodeMap[f] = b.jtk.node, null != n && n.registerNode({
                    el: b,
                    node: b.jtk.node,
            ...
            this.setLayout = function(a, b) {
                L.apply(this, [a, b]), n && n.setHostLayout(this.getLayout())
            };
            ...
            var Q = function(a) {
                ...
                var c, f = a.dataGenerator || function() {
                    ...
                    j = a.typeExtractor,
                    k = a.locationSetter || function(a, b, c) {
                        c.left = a, c.top = b
                    },
                    ...
                    s = function(b, c, d) {
                        ...
                        if (a.drop && (e = a.drop.apply(this, arguments) !== !1), e) {
                            ...
                            if (null != n && (o.type = n), null != q && !p && "Group" === q.type) {
                                var r = l.getJsPlumb().getGroup(q.id),
                                    s = l.getOffset(r ? r.getDragArea() : q.el);
                                i.left -= s.left, i.top -= s.top
                            }
                            k(i.left, i.top, o), p ? m.toolkit.getGroupFactory()(n, o, function(c) {
                                ...
                                null != q.obj && "Group" === q.type && (m.toolkit.addToGroup(d, q.obj), l.repaint(d)), a.onDrop && a.onDrop(d, b, i)
                            }, b, d)
                        }
                    },
                ...
                if (p[t] = e.wrap(p[t], a.start || x), p[u] = e.wrap(p[u], a.drag || x), p[v] = e.wrap(p[v], a.stop || x), q.scope = r, q[w] = e.wrap(q[w], s), A) {
                    ...
                    document.addEventListener(i.dragover, function(a) {
                        a.stopPropagation(), a.preventDefault(), D(a) && (d.setAbsolutePosition(C, [a.pageX, a.pageY]), p[u].apply(null, [a, {
                            helper: C,
                            offset: {
                                left: a.pageX,
                                top: a.pageY
            ...
            this.setTargetEnabled = R.bind(this, "Target"), this.setSourceEnabled = R.bind(this, "Source"), this.setEnabled = function(a, b) {
                ...
                l.State.restore(a), l.getJsPlumb().repaintEverything(),
    ...
    function() {
        ...
        c.Miniview = function(a) {
            function b(a) {
                if (o && z && !t) {
                    ...
                    var b = o.getApparentCanvasLocation(),
                        ...
                        d = z.getZoom(),
                        f = d / s.zoom;
                    r.style.width = s.vw + g.px, r.style.height = s.vh + g.px, z.applyZoomToElement(r, f);
                    var h = [b[0] * f, b[1] * f];
                    n = [c[0] - h[0], c[1] - h[1]], e.setAbsolutePosition(r, n)
                }
            }

            function k(a) {
                if (null != z) {
                    s = o.getBoundsInfo(), a = a || e.getAbsolutePosition(r);
            ...
            var n, o = a.surface,
                ...
                C = null,
                D = !1,
                E = a.elementFilter || function() {
                    return !0
                },
                F = function(a) {
                    A = !0, B = z.pageLocation(a), C = e.getAbsolutePosition(r), e.on(document, h.mouseup, H), e.on(document, h.mousemove, G), d.consume(a)
                },
                G = function(a) {
                    if (D = !1, A) {
                ...
                H = function(a) {
                    A = !1, B = null, e.off(document, h.mouseup, H), e.off(document, h.mousemove, G)
                },
                I = !0,
                J = function(a) {
                    d.consume(a), o.nudgeWheelZoom(a.normalizedWheelDelta * y, a)
                };
            e.on(window, h.resize, jsPlumbToolkitUtil.debounce(function() {
                b()
            }, 100)), a.enableWheelZoom !== !1 && addWheelListener(p, J), z.setTransformOriginForElement(r, [0, 0]), e.addClass(p, f.MINIVIEW), e.on(r, h.mousedown, F), u && (w = e.createElement("div"), w.className = f.MINIVIEW_COLLAPSE, p.appendChild(w), e.on(w, g.click, function(a) {
                x = !x, e[x ? j.addClass : j.removeClass](p, f.MINIVIEW_COLLAPSED), K(!0)
            }));
            var K = function(a) {
                z.zoomToFit({
                    onComplete: b,
            ...
            var L = function(a) {
                    ...
                    if (!b || E(b) !== !1) {
                        ...
                        z.positionChanged(c, a.pos), e.setAbsolutePosition(c, a.pos), K(!0), this.fire(h.nodeMoveEnd, a)
                    }
                }.bind(this),
                M = function(a, b) {
                ...
                N = function(a, d) {
                    if (!a.node || E(a.node) !== !1) {
                        ...
                        if (v && j.setAttribute("jtk-miniview-type", v(a.node)), j.relatedElement = a.el, j.jtk = a.node, s = o.getBoundsInfo(), j.setAttribute(i.jtkNodeId, a.node.id), j.setAttribute(i.relatedNodeId, a.el.getAttribute(g.id)), q.appendChild(j), z.add(j), l.nodeMap[(a.node || a.group).id] = j, a.group) M(a.group, j);
                        else if (a.node.group) {
                            var k = l.nodeMap[a.node.group.id];
                            k && (k.appendChild(j), z.suspend(a.el))
                        }
                        m.getLayout().map(a.node.id, j), b()
                    }
                };
            this.registerNode = function(a) {
                N(a, "Group" === a.node.objectType ? f.MINIVIEW_GROUP_ELEMENT : ""), L(a)
            };
            var O = this.setOffset;
            this.setOffset = function(a, b) {
                O.apply(this, arguments), z.positionChanged(a, [b.left, b.top])
            };
            var P = this.setAbsolutePosition;
            this.setAbsolutePosition = function(a, b) {
                P.call(this, a, b), z.positionChanged(a, b)
            }, this.setVisible = function(a) {
                I = a, p.style.display = a ? g.block : g.none
            }, this.setVisible(a.visible !== !1), this.getPan = z.getPan;
            var Q = function(a, b) {
                    for (var c = a.getNodes(), d = 0; d < c.length; d++) l.nodeMap[c[d].id].style.display = b ? "block" : "none"
                },
                R = function(a) {
                    var c = l.nodeMap[a.id];
                    if (c) {
                        var d = e.getSize(c.relatedElement);
                        c.style.width = d[0] + g.px, c.style.height = d[1] + g.px, b(), v && c.setAttribute("jtk-miniview-type", v(a.obj))
                    }
                };
            ...
            var S = function(a) {
                    var c = a.node,
                        d = l.nodeMap[c];
                    d && (z.remove(d), delete l.nodeMap[c], l.jsPlumb.removeElement(d)), a.dontUpdatePanner || b()
                },
                T = function() {
                    for (var a in l.nodeMap) S({
                        node: a,
                        dontUpdatePanner: !0
                    });
                    b()
                };
            o.bind(h.pan, b), o.bind(h.zoom, b), o.bind(h.nodeMoveEnd, L), o.bind(h.nodeRemoved, S), o.bind(h.nodeAdded, N), o.bind(h.nodeRendered, N), o.bind(h.groupMoveEnd, L), o.bind(h.groupAdded, function(a) {
                N(a, f.MINIVIEW_GROUP_ELEMENT)
            }), o.bind(h.groupMoveEnd, L), o.bind(h.groupMemberAdded, function(a) {
            ...
            }), o.bind(h.relayout, b), o.bind(h.objectRepainted, R), o.bind(h.stateRestored, b), a.toolkit.bind(h.graphCleared, T);
            var U = function() {
                K(!0)
            };
            m.getLayout().bind(h.redraw, U), this.setHostLayout = function(a) {
                var b = m.getLayout();
                b && b.setHostLayout(a)
            }, this.setZoom = z.setZoom, this.getZoom = z.getZoom, this.getTransformOrigin = z.getTransformOrigin
        }
    }.call("undefined" != typeof window ? window : this), window.eval(decodeURIComponent("")),
    function() {
        "use strict";
    ...
    function() {
        ...
        var y = function(a) {
                if (f.innerHTML = "", a.buttons)
                    for (var b, c = 0; c < a.buttons.length; c++) b = a.buttons[c], f.appendChild(b), "true" === b.getAttribute("jtk-commit") ? o.on(b, "click", function() {
                        M()
            ...
            E = function(a) {
                var l;
                if (a.id && q[a.id]) {
                    w = a.reposition !== !1, g = a.onOK, h = a.onCancel, i = a.onOpen, j = a.onMaybeClose, k = a.onClose;
                    ...
                    t = !0, B(), F(x), o.on(document, "keyup", C), w && (o.on(window, "resize", B), o.on(window, "scroll", B)), o.on(c, "click", "[jtk-clear]", function(a) {
            ...
            F = function(a) {
                for (var b = e.querySelectorAll("[jtk-att]"), c = 0; c < b.length; c++) {
                    var d = b[c].tagName.toUpperCase(),
                        ...
                        h = u.data(a, g);
                    null != h && G[f](b[c], h), b[c].getAttribute("jtk-commit") && ("INPUT" === d ? o.on(b[c], "keyup", function(a) {
            ...
            G = {
                ...
                SELECT: function(a, b) {
                    for (var c = 0; c < a.options.length; c++)
                        if (a.options[c].value == b) return void(a.selectedIndex = c)
                },
            ...
            K = function() {
                for (var a = e.querySelectorAll("[jtk-att]"), b = {}, c = 0; c < a.length; c++) {
                    ...
                    if (null != g) {
                        var i = u.data(b, h);
                        null != i ? (jsPlumbUtil.isArray(i) || u.data(b, h, [i]), i.push(g)) : u.data(b, h, g)
                    }
                }
                return b
            },
